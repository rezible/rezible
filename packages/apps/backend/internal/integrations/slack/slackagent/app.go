...
func MakeApp(cfg rez.Config, db rez.Database, jobSvc rez.JobService, msgs rez.MessageService, agents rez.AiAgentService, events rez.EventsService) (*App, error) {
	h := &App{
		cfg:      cfg,
		db:       db,
		jobs:     jobSvc,

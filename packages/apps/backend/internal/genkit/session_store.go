...
func convertToSessionSnapshot[S any](rs *ent.AgentRunSnapshot) (*aix.SessionSnapshot[S], error) {
	if rs == nil {
		return nil, nil
	}
...
func convertFromSessionSnapshot[S any](s *aix.SessionSnapshot[S]) (*ent.AgentRunSnapshot, error) {
	if s == nil {
		return nil, nil
	}
	...
	snap := &ent.AgentRunSnapshot{
		ID:           snapshotId,
		CreatedAt:    s.CreatedAt,
		UpdatedAt:    s.UpdatedAt,
		AgentRunID:   sessId,
		ParentID:     parentId,
		Status:       ars.Status(s.Status),
...
func (s *agentSessionStore[S]) SaveSnapshot(ctx context.Context, id string, setFn setSnapshotDataFunc[S]) (*aix.SessionSnapshot[S], error) {
	...
	updateFn := func(rs *ent.AgentRunSnapshot, m *ent.AgentRunSnapshotMutation) error {
	...
	updated, updateErr := s.snapshots.UpdateSnapshot(ctx, snapshotId, updateFn)
	if updateErr != nil {

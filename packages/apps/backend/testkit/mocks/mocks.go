...
func (_mock *MockProviderEventPipelineService) SyncEvents(ctx context.Context, q rez.ProviderEventQuerier, sourceCursors map[string]string) rez.ProviderEventSyncResult {
	ret := _mock.Called(ctx, q, sourceCursors)
	...
	if returnFunc, ok := ret.Get(0).(func(context.Context, rez.ProviderEventQuerier, map[string]string) rez.ProviderEventSyncResult); ok {
		r0 = returnFunc(ctx, q, sourceCursors)
	} else {
...
//   - ctx context.Context
//   - q rez.ProviderEventQuerier
//   - sourceCursors map[string]string
func (_e *MockProviderEventPipelineService_Expecter) SyncEvents(ctx interface{}, q interface{}, sourceCursors interface{}) *MockProviderEventPipelineService_SyncEvents_Call {
	return &MockProviderEventPipelineService_SyncEvents_Call{Call: _e.mock.On("SyncEvents", ctx, q, sourceCursors)}
}

func (_c *MockProviderEventPipelineService_SyncEvents_Call) Run(run func(ctx context.Context, q rez.ProviderEventQuerier, sourceCursors map[string]string)) *MockProviderEventPipelineService_SyncEvents_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockProviderEventPipelineService_SyncEvents_Call) RunAndReturn(run func(ctx context.Context, q rez.ProviderEventQuerier, sourceCursors map[string]string) rez.ProviderEventSyncResult) *MockProviderEventPipelineService_SyncEvents_Call {
	_c.Call.Return(run)
	return _c
}

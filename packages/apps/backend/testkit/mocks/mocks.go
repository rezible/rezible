...
// InsertManyTx provides a mock function for the type MockJobService
func (_mock *MockJobService) InsertManyTx(ctx context.Context, tx *ent.Tx, params []river.InsertManyParams) ([]*rivertype.JobInsertResult, error) {
	...
	var r0 []*rivertype.JobInsertResult
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, *ent.Tx, []river.InsertManyParams) ([]*rivertype.JobInsertResult, error)); ok {
		return returnFunc(ctx, tx, params)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, *ent.Tx, []river.InsertManyParams) []*rivertype.JobInsertResult); ok {
	...
	if returnFunc, ok := ret.Get(1).(func(context.Context, *ent.Tx, []river.InsertManyParams) error); ok {
...
// MockJobService_InsertManyTx_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'InsertManyTx'
type MockJobService_InsertManyTx_Call struct {
	*mock.Call
}
...
func (_e *MockJobService_Expecter) InsertManyTx(ctx interface{}, tx interface{}, params interface{}) *MockJobService_InsertManyTx_Call {
	return &MockJobService_InsertManyTx_Call{Call: _e.mock.On("InsertManyTx", ctx, tx, params)}
}

func (_c *MockJobService_InsertManyTx_Call) Run(run func(ctx context.Context, tx *ent.Tx, params []river.InsertManyParams)) *MockJobService_InsertManyTx_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockJobService_InsertManyTx_Call) Return(jobInsertResults []*rivertype.JobInsertResult, err error) *MockJobService_InsertManyTx_Call {
	_c.Call.Return(jobInsertResults, err)
	return _c
}

func (_c *MockJobService_InsertManyTx_Call) RunAndReturn(run func(ctx context.Context, tx *ent.Tx, params []river.InsertManyParams) ([]*rivertype.JobInsertResult, error)) *MockJobService_InsertManyTx_Call {
	_c.Call.Return(run)
	return _c
}

// InsertTx provides a mock function for the type MockJobService
func (_mock *MockJobService) InsertTx(context1 context.Context, tx *ent.Tx, jobArgs river.JobArgs, insertOpts *river.InsertOpts) (*rivertype.JobInsertResult, error) {
...
// MockJobService_InsertTx_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'InsertTx'
type MockJobService_InsertTx_Call struct {
	*mock.Call
}
...
//   - jobArgs river.JobArgs
//   - insertOpts *river.InsertOpts
func (_e *MockJobService_Expecter) InsertTx(context1 interface{}, tx interface{}, jobArgs interface{}, insertOpts interface{}) *MockJobService_InsertTx_Call {
	return &MockJobService_InsertTx_Call{Call: _e.mock.On("InsertTx", context1, tx, jobArgs, insertOpts)}
}

func (_c *MockJobService_InsertTx_Call) Run(run func(context1 context.Context, tx *ent.Tx, jobArgs river.JobArgs, insertOpts *river.InsertOpts)) *MockJobService_InsertTx_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockJobService_InsertTx_Call) Return(jobInsertResult *rivertype.JobInsertResult, err error) *MockJobService_InsertTx_Call {
	_c.Call.Return(jobInsertResult, err)
	return _c
}

func (_c *MockJobService_InsertTx_Call) RunAndReturn(run func(context1 context.Context, tx *ent.Tx, jobArgs river.JobArgs, insertOpts *river.InsertOpts) (*rivertype.JobInsertResult, error)) *MockJobService_InsertTx_Call {
	_c.Call.Return(run)
	return _c
}

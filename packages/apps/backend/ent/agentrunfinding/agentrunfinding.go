...
const (
	// Label holds the string label denoting the agentrunfinding type in the database.
	Label = "agent_run_finding"
	...
	TenantTable = "agent_run_findings"
...
// OrderOption defines the ordering options for the AgentRunFinding queries.

...
const (
	// Label holds the string label denoting the agentrunsnapshot type in the database.
	Label = "agent_run_snapshot"
	...
	TenantTable = "agent_run_snapshots"
	...
	AgentRunTable = "agent_run_snapshots"

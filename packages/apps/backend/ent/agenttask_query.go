...
func (_q *AgentTaskQuery) QueryTenant() *TenantQuery {
...
func (_q *AgentTaskQuery) QueryOwnerUser() *UserQuery {
...
func (_q *AgentTaskQuery) QueryRuns() *AgentRunQuery {
...
func (_q *AgentTaskQuery) QueryCitations() *AgentRunCitationQuery {
...
func (_q *AgentTaskQuery) WithTenant(opts ...func(*TenantQuery)) *AgentTaskQuery {
	query := (&TenantClient{config: _q.config}).Query()
...
func (_q *AgentTaskQuery) WithOwnerUser(opts ...func(*UserQuery)) *AgentTaskQuery {
	query := (&UserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *AgentTaskQuery) WithRuns(opts ...func(*AgentRunQuery)) *AgentTaskQuery {
	query := (&AgentRunClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *AgentTaskQuery) WithCitations(opts ...func(*AgentRunCitationQuery)) *AgentTaskQuery {
	query := (&AgentRunCitationClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
//		GroupBy(agenttask.FieldTenantID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.AgentTask.Query().
//		Select(agenttask.FieldTenantID).
//		Scan(ctx, &v)
...
func (_q *AgentTaskQuery) prepareQuery(ctx context.Context) error {
	...
	if agenttask.Policy == nil {
		return errors.New("ent: uninitialized agenttask.Policy (forgotten import ent/runtime?)")
	}
	if err := agenttask.Policy.EvalQuery(ctx, _q); err != nil {
		return err
	}
	return nil
}
...
func (_q *AgentTaskQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*AgentTask, error) {
	...
	_spec.Node.Schema = _q.schemaConfig.AgentTask
	...
	if query := _q.withTenant; query != nil {
		if err := _q.loadTenant(ctx, query, nodes, nil,
			func(n *AgentTask, e *Tenant) { n.Edges.Tenant = e }); err != nil {
			return nil, err
		}
	}
	...
	if query := _q.withRuns; query != nil {
		if err := _q.loadRuns(ctx, query, nodes,
			func(n *AgentTask) { n.Edges.Runs = []*AgentRun{} },
			func(n *AgentTask, e *AgentRun) { n.Edges.Runs = append(n.Edges.Runs, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withCitations; query != nil {
		if err := _q.loadCitations(ctx, query, nodes,
			func(n *AgentTask) { n.Edges.Citations = []*AgentRunCitation{} },
			func(n *AgentTask, e *AgentRunCitation) { n.Edges.Citations = append(n.Edges.Citations, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *AgentTaskQuery) loadTenant(ctx context.Context, query *TenantQuery, nodes []*AgentTask, init func(*AgentTask), assign func(*AgentTask, *Tenant)) error {
	ids := make([]int, 0, len(nodes))
	nodeids := make(map[int][]*AgentTask)
	for i := range nodes {
		fk := nodes[i].TenantID
...
func (_q *AgentTaskQuery) loadOwnerUser(ctx context.Context, query *UserQuery, nodes []*AgentTask, init func(*AgentTask), assign func(*AgentTask, *User)) error {
...
func (_q *AgentTaskQuery) loadRuns(ctx context.Context, query *AgentRunQuery, nodes []*AgentTask, init func(*AgentTask), assign func(*AgentTask, *AgentRun)) error {
	...
	query.Where(predicate.AgentRun(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(agenttask.RunsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		...
		node, ok := nodeids[fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "agent_task_id" returned %v for node %v`, fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (_q *AgentTaskQuery) loadCitations(ctx context.Context, query *AgentRunCitationQuery, nodes []*AgentTask, init func(*AgentTask), assign func(*AgentTask, *AgentRunCitation)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*AgentTask)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(agentruncitation.FieldAgentTaskID)
	}
	query.Where(predicate.AgentRunCitation(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(agenttask.CitationsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.AgentTaskID
		if fk == nil {
			return fmt.Errorf(`foreign-key "agent_task_id" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "agent_task_id" returned %v for node %v`, *fk, n.ID)
...
func (_q *AgentTaskQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withTenant != nil {
			_spec.Node.AddColumnOnce(agenttask.FieldTenantID)
		}
		if _q.withOwnerUser != nil {
			_spec.Node.AddColumnOnce(agenttask.FieldOwnerUserID)
		}
	}
...
func (_q *AgentTaskQuery) sqlQuery(ctx context.Context) *sql.Selector {
	...
	t1.Schema(_q.schemaConfig.AgentTask)
	ctx = internal.NewSchemaConfigContext(ctx, _q.schemaConfig)
...
func (_q *AgentTaskQuery) Modify(modifiers ...func(s *sql.Selector)) *AgentTaskSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (_s *AgentTaskSelect) Modify(modifiers ...func(s *sql.Selector)) *AgentTaskSelect {

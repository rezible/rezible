...
const (
	...
	PrimaryShiftTable = "oncall_shifts"
	...
	HandoverTable = "oncall_shift_handovers"
	// HandoverInverseTable is the table name for the OncallShiftHandover entity.
	// It exists in this package in order to avoid circular dependency with the "oncallshifthandover" package.
	HandoverInverseTable = "oncall_shift_handovers"
	...
	MetricsTable = "oncall_shift_metrics"
	// MetricsInverseTable is the table name for the OncallShiftMetrics entity.
	// It exists in this package in order to avoid circular dependency with the "oncallshiftmetrics" package.
	MetricsInverseTable = "oncall_shift_metrics"
...
func RoleValidator(r Role) error {
	...
	case RolePrimary, RoleSecondary, RoleShadow, RoleCovering:
		return nil
	default:
		return fmt.Errorf("oncallshift: invalid enum value for role field: %q", r)
	}
}

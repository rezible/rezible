...
const (
	// Label holds the string label denoting the investigationhypothesis type in the database.
	Label = "investigation_hypothesis"
	...
	TenantTable = "investigation_hypotheses"
	...
	InvestigationTable = "investigation_hypotheses"
...
// OrderOption defines the ordering options for the InvestigationHypothesis queries.

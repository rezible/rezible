...
const (
	// Label holds the string label denoting the incidenttimelineeventevidence type in the database.
	Label = "incident_timeline_event_evidence"
	...
	EdgeEvent = "event"
	// Table holds the table name of the incidenttimelineeventevidence in the database.
	Table = "incident_timeline_event_evidences"
	// TenantTable is the table that holds the tenant relation/edge.
	TenantTable = "incident_timeline_event_evidences"
	...
	EventTable = "incident_timeline_event_evidences"
	...
	EventColumn = "incident_timeline_event_evidence"
)

// Columns holds all SQL columns for incidenttimelineeventevidence fields.
var Columns = []string{
	FieldID,
	FieldTenantID,
	FieldEvidenceType,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "incident_timeline_event_evidences"
// table and are not defined as standalone fields in the schema.
var ForeignKeys = []string{
	"incident_timeline_event_evidence",
}
...
func EvidenceTypeValidator(et EvidenceType) error {
	...
	case EvidenceTypeLog, EvidenceTypeMetric, EvidenceTypeChat, EvidenceTypeTicket, EvidenceTypeOther:
		return nil
	default:
		return fmt.Errorf("incidenttimelineeventevidence: invalid enum value for evidence_type field: %q", et)
	}
}

// OrderOption defines the ordering options for the IncidentTimelineEventEvidence queries.

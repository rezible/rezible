...
const (
	// Label holds the string label denoting the investigationfinding type in the database.
	...
	TenantTable = "investigation_findings"
	...
	InvestigationTable = "investigation_findings"
...
// OrderOption defines the ordering options for the InvestigationFinding queries.

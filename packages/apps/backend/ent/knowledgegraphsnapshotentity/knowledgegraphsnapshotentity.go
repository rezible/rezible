...
const (
	// Label holds the string label denoting the knowledgegraphsnapshotentity type in the database.
	Label = "knowledge_graph_snapshot_entity"
	...
	// Table holds the table name of the knowledgegraphsnapshotentity in the database.
	Table = "knowledge_graph_snapshot_entities"
	// TenantTable is the table that holds the tenant relation/edge.
	TenantTable = "knowledge_graph_snapshot_entities"
	...
	SnapshotTable = "knowledge_graph_snapshot_entities"
	...
	KnowledgeEntityTable = "knowledge_graph_snapshot_entities"
	...
	SourceRelationshipsTable = "knowledge_graph_snapshot_relationships"
	// SourceRelationshipsInverseTable is the table name for the KnowledgeGraphSnapshotRelationship entity.
	// It exists in this package in order to avoid circular dependency with the "knowledgegraphsnapshotrelationship" package.
	SourceRelationshipsInverseTable = "knowledge_graph_snapshot_relationships"
	...
	TargetRelationshipsTable = "knowledge_graph_snapshot_relationships"
	// TargetRelationshipsInverseTable is the table name for the KnowledgeGraphSnapshotRelationship entity.
	// It exists in this package in order to avoid circular dependency with the "knowledgegraphsnapshotrelationship" package.
	TargetRelationshipsInverseTable = "knowledge_graph_snapshot_relationships"
...
// Columns holds all SQL columns for knowledgegraphsnapshotentity fields.
var Columns = []string{
	FieldID,
	FieldTenantID,
	FieldSnapshotID,
...
// OrderOption defines the ordering options for the KnowledgeGraphSnapshotEntity queries.

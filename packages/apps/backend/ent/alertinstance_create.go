...
func (_c *AlertInstanceCreate) AddFeedbackIDs(ids ...uuid.UUID) *AlertInstanceCreate {
	_c.mutation.AddFeedbackIDs(ids...)
	return _c
}

// AddFeedback adds the "feedback" edges to the AlertFeedback entity.
func (_c *AlertInstanceCreate) AddFeedback(v ...*AlertFeedback) *AlertInstanceCreate {

...
const (
	// Label holds the string label denoting the incidenttimelineeventtopologycontext type in the database.
	Label = "incident_timeline_event_topology_context"
	...
	Table = "incident_timeline_event_topology_contexts"
	// TenantTable is the table that holds the tenant relation/edge.
	TenantTable = "incident_timeline_event_topology_contexts"
	...
	EventTable = "incident_timeline_event_topology_contexts"
...
// Columns holds all SQL columns for incidenttimelineeventtopologycontext fields.
var Columns = []string{
	FieldID,
	FieldTenantID,
...
func RelationshipValidator(r Relationship) error {
	...
	case RelationshipPrimary, RelationshipAffected, RelationshipContributing:
		return nil
	default:
		return fmt.Errorf("incidenttimelineeventtopologycontext: invalid enum value for relationship field: %q", r)
	}
}

// OrderOption defines the ordering options for the IncidentTimelineEventTopologyContext queries.

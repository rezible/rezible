...
func (_q *OrganizationRoleQuery) QueryTenant() *TenantQuery {
...
func (_q *OrganizationRoleQuery) QueryUser() *UserQuery {
...
func (_q *OrganizationRoleQuery) WithTenant(opts ...func(*TenantQuery)) *OrganizationRoleQuery {
	query := (&TenantClient{config: _q.config}).Query()
...
func (_q *OrganizationRoleQuery) WithUser(opts ...func(*UserQuery)) *OrganizationRoleQuery {
	query := (&UserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
//		GroupBy(organizationrole.FieldTenantID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.OrganizationRole.Query().
//		Select(organizationrole.FieldTenantID).
//		Scan(ctx, &v)
...
func (_q *OrganizationRoleQuery) prepareQuery(ctx context.Context) error {
	...
	if organizationrole.Policy == nil {
		return errors.New("ent: uninitialized organizationrole.Policy (forgotten import ent/runtime?)")
	}
	if err := organizationrole.Policy.EvalQuery(ctx, _q); err != nil {
		return err
	}
	return nil
}
...
func (_q *OrganizationRoleQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*OrganizationRole, error) {
	...
	_spec.Node.Schema = _q.schemaConfig.OrganizationRole
	...
	if query := _q.withTenant; query != nil {
		if err := _q.loadTenant(ctx, query, nodes, nil,
			func(n *OrganizationRole, e *Tenant) { n.Edges.Tenant = e }); err != nil {
			return nil, err
		}
	}
	...
	if query := _q.withUser; query != nil {
		if err := _q.loadUser(ctx, query, nodes, nil,
			func(n *OrganizationRole, e *User) { n.Edges.User = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *OrganizationRoleQuery) loadTenant(ctx context.Context, query *TenantQuery, nodes []*OrganizationRole, init func(*OrganizationRole), assign func(*OrganizationRole, *Tenant)) error {
...
func (_q *OrganizationRoleQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*OrganizationRole, init func(*OrganizationRole), assign func(*OrganizationRole, *User)) error {
	ids := make([]uuid.UUID, 0, len(nodes))
	nodeids := make(map[uuid.UUID][]*OrganizationRole)
	for i := range nodes {
		fk := nodes[i].UserID
...
func (_q *OrganizationRoleQuery) sqlQuery(ctx context.Context) *sql.Selector {
	...
	t1.Schema(_q.schemaConfig.OrganizationRole)
	ctx = internal.NewSchemaConfigContext(ctx, _q.schemaConfig)
...
func (_q *OrganizationRoleQuery) Modify(modifiers ...func(s *sql.Selector)) *OrganizationRoleSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (_s *OrganizationRoleSelect) Modify(modifiers ...func(s *sql.Selector)) *OrganizationRoleSelect {

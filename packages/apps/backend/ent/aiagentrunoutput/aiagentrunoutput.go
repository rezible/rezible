...
const (
	// Label holds the string label denoting the aiagentrunoutput type in the database.
	Label = "ai_agent_run_output"
	...
	TenantTable = "ai_agent_run_outputs"
...
// OrderOption defines the ordering options for the AiAgentRunOutput queries.

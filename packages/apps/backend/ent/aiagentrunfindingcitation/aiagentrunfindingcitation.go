...
const (
	// Label holds the string label denoting the aiagentrunfindingcitation type in the database.
	Label = "ai_agent_run_finding_citation"
	...
	// Table holds the table name of the aiagentrunfindingcitation in the database.
	Table = "ai_agent_run_finding_citations"
	// TenantTable is the table that holds the tenant relation/edge.
	TenantTable = "ai_agent_run_finding_citations"
	...
	FindingTable = "ai_agent_run_finding_citations"
	// FindingInverseTable is the table name for the AiAgentRunFinding entity.
	// It exists in this package in order to avoid circular dependency with the "aiagentrunfinding" package.
	FindingInverseTable = "ai_agent_run_findings"
	...
	CitationTable = "ai_agent_run_finding_citations"
	// CitationInverseTable is the table name for the AiAgentRunCitation entity.
	// It exists in this package in order to avoid circular dependency with the "aiagentruncitation" package.
	CitationInverseTable = "ai_agent_run_citations"
	// CitationColumn is the table column denoting the citation relation/edge.
	CitationColumn = "citation_id"
)

// Columns holds all SQL columns for aiagentrunfindingcitation fields.
var Columns = []string{
	FieldID,
	FieldTenantID,
	FieldCreatedAt,
...
// OrderOption defines the ordering options for the AiAgentRunFindingCitation queries.

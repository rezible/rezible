...
const (
	// Label holds the string label denoting the incidenttimelineevent type in the database.
	Label = "incident_timeline_event"
	...
	TenantTable = "incident_timeline_events"
	...
	IncidentTable = "incident_timeline_events"
	...
	EventTable = "incident_timeline_events"
	...
	ContextTable = "incident_timeline_event_contexts"
	// ContextInverseTable is the table name for the IncidentTimelineEventContext entity.
	// It exists in this package in order to avoid circular dependency with the "incidenttimelineeventcontext" package.
	ContextInverseTable = "incident_timeline_event_contexts"
	// ContextColumn is the table column denoting the context relation/edge.
	ContextColumn = "incident_timeline_event_context"
	// FactorsTable is the table that holds the factors relation/edge.
	FactorsTable = "incident_timeline_event_contributing_factors"
	// FactorsInverseTable is the table name for the IncidentTimelineEventContributingFactor entity.
	// It exists in this package in order to avoid circular dependency with the "incidenttimelineeventcontributingfactor" package.
	FactorsInverseTable = "incident_timeline_event_contributing_factors"
	// FactorsColumn is the table column denoting the factors relation/edge.
	FactorsColumn = "incident_timeline_event_factors"
	// EvidenceTable is the table that holds the evidence relation/edge.
	EvidenceTable = "incident_timeline_event_evidences"
	// EvidenceInverseTable is the table name for the IncidentTimelineEventEvidence entity.
	// It exists in this package in order to avoid circular dependency with the "incidenttimelineeventevidence" package.
...
func KindValidator(k Kind) error {
	...
	case KindObservation, KindContext, KindDecision, KindAction:
		return nil
	default:
		return fmt.Errorf("incidenttimelineevent: invalid enum value for kind field: %q", k)
	}
}

// OrderOption defines the ordering options for the IncidentTimelineEvent queries.

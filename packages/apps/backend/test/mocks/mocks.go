...
// Publish provides a mock function for the type MockMessageQueue
func (_mock *MockMessageQueue) Publish(context1 context.Context, v any) error {
...
//   - v any
func (_e *MockMessageQueue_Expecter) Publish(context1 interface{}, v interface{}) *MockMessageQueue_Publish_Call {
	return &MockMessageQueue_Publish_Call{Call: _e.mock.On("Publish", context1, v)}
}

func (_c *MockMessageQueue_Publish_Call) Run(run func(context1 context.Context, v any)) *MockMessageQueue_Publish_Call {
...
func (_c *MockMessageQueue_Publish_Call) Return(err error) *MockMessageQueue_Publish_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockMessageQueue_Publish_Call) RunAndReturn(run func(context1 context.Context, v any) error) *MockMessageQueue_Publish_Call {
	_c.Call.Return(run)
	return _c
}

// PublishLive provides a mock function for the type MockMessageQueue
func (_mock *MockMessageQueue) PublishLive(context1 context.Context, v any) error {
	ret := _mock.Called(context1, v)

	if len(ret) == 0 {
		panic("no return value specified for PublishLive")
	}
...
// MockMessageQueue_PublishLive_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'PublishLive'
type MockMessageQueue_PublishLive_Call struct {
	*mock.Call
}

// PublishLive is a helper method to define mock.On call
//   - context1 context.Context
//   - v any
func (_e *MockMessageQueue_Expecter) PublishLive(context1 interface{}, v interface{}) *MockMessageQueue_PublishLive_Call {
	return &MockMessageQueue_PublishLive_Call{Call: _e.mock.On("PublishLive", context1, v)}
}

func (_c *MockMessageQueue_PublishLive_Call) Run(run func(context1 context.Context, v any)) *MockMessageQueue_PublishLive_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockMessageQueue_PublishLive_Call) Return(err error) *MockMessageQueue_PublishLive_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockMessageQueue_PublishLive_Call) RunAndReturn(run func(context1 context.Context, v any) error) *MockMessageQueue_PublishLive_Call {
	_c.Call.Return(run)
	return _c
}

// Subscribe provides a mock function for the type MockMessageQueue
func (_mock *MockMessageQueue) Subscribe(context1 context.Context, messageEventSubscriptionOpts *rez.MessageEventSubscriptionOpts, messageEventHandlers ...rez.MessageEventHandler) error {
...
func (_e *MockMessageQueue_Expecter) Subscribe(context1 interface{}, messageEventSubscriptionOpts interface{}, messageEventHandlers ...interface{}) *MockMessageQueue_Subscribe_Call {
	return &MockMessageQueue_Subscribe_Call{Call: _e.mock.On("Subscribe",
		append([]interface{}{context1, messageEventSubscriptionOpts}, messageEventHandlers...)...)}
}

func (_c *MockMessageQueue_Subscribe_Call) Run(run func(context1 context.Context, messageEventSubscriptionOpts *rez.MessageEventSubscriptionOpts, messageEventHandlers ...rez.MessageEventHandler)) *MockMessageQueue_Subscribe_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockMessageQueue_Subscribe_Call) Return(err error) *MockMessageQueue_Subscribe_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockMessageQueue_Subscribe_Call) RunAndReturn(run func(context1 context.Context, messageEventSubscriptionOpts *rez.MessageEventSubscriptionOpts, messageEventHandlers ...rez.MessageEventHandler) error) *MockMessageQueue_Subscribe_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *MockKnowledgeGraphService) IngestEvidence(context1 context.Context, normalizedEvent *ent.NormalizedEvent, knowledgeEvidenceRefs ...rez.KnowledgeEvidenceRef) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for IngestEvidence")
	}
...
// MockKnowledgeGraphService_IngestEvidence_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'IngestEvidence'
type MockKnowledgeGraphService_IngestEvidence_Call struct {
	*mock.Call
}
...
func (_c *MockKnowledgeGraphService_IngestEvidence_Call) Return(err error) *MockKnowledgeGraphService_IngestEvidence_Call {
	_c.Call.Return(err)
	return _c
}
...
// CompleteOrgSetup provides a mock function for the type MockOrganizationService
func (_mock *MockOrganizationService) CompleteOrgSetup(context1 context.Context, uUID uuid.UUID, completeOrgSetupParams rez.CompleteOrgSetupParams) (*ent.Organization, error) {
	ret := _mock.Called(context1, uUID, completeOrgSetupParams)

	if len(ret) == 0 {
		panic("no return value specified for CompleteOrgSetup")
	}

	var r0 *ent.Organization
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, uuid.UUID, rez.CompleteOrgSetupParams) (*ent.Organization, error)); ok {
		return returnFunc(context1, uUID, completeOrgSetupParams)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, uuid.UUID, rez.CompleteOrgSetupParams) *ent.Organization); ok {
		r0 = returnFunc(context1, uUID, completeOrgSetupParams)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*ent.Organization)
		}
	}
	if returnFunc, ok := ret.Get(1).(func(context.Context, uuid.UUID, rez.CompleteOrgSetupParams) error); ok {
		r1 = returnFunc(context1, uUID, completeOrgSetupParams)
	} else {
		r1 = ret.Error(1)
	}
	return r0, r1
...
// MockOrganizationService_CompleteOrgSetup_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CompleteOrgSetup'
type MockOrganizationService_CompleteOrgSetup_Call struct {
	*mock.Call
}

// CompleteOrgSetup is a helper method to define mock.On call
//   - context1 context.Context
//   - uUID uuid.UUID
//   - completeOrgSetupParams rez.CompleteOrgSetupParams
func (_e *MockOrganizationService_Expecter) CompleteOrgSetup(context1 interface{}, uUID interface{}, completeOrgSetupParams interface{}) *MockOrganizationService_CompleteOrgSetup_Call {
	return &MockOrganizationService_CompleteOrgSetup_Call{Call: _e.mock.On("CompleteOrgSetup", context1, uUID, completeOrgSetupParams)}
}

func (_c *MockOrganizationService_CompleteOrgSetup_Call) Run(run func(context1 context.Context, uUID uuid.UUID, completeOrgSetupParams rez.CompleteOrgSetupParams)) *MockOrganizationService_CompleteOrgSetup_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
		...
		var arg2 rez.CompleteOrgSetupParams
		if args[2] != nil {
			arg2 = args[2].(rez.CompleteOrgSetupParams)
		}
		run(
			arg0,
			arg1,
...
func (_c *MockOrganizationService_CompleteOrgSetup_Call) Return(organization *ent.Organization, err error) *MockOrganizationService_CompleteOrgSetup_Call {
	_c.Call.Return(organization, err)
	return _c
}

func (_c *MockOrganizationService_CompleteOrgSetup_Call) RunAndReturn(run func(context1 context.Context, uUID uuid.UUID, completeOrgSetupParams rez.CompleteOrgSetupParams) (*ent.Organization, error)) *MockOrganizationService_CompleteOrgSetup_Call {
	_c.Call.Return(run)
	return _c
}

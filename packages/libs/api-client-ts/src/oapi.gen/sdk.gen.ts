 ...
 * Request Agent Run
 */
export const requestAgentRun = <ThrowOnError extends boolean = false>(options: Options<RequestAgentRunData, ThrowOnError>) => (options.client ?? client).post<RequestAgentRunResponses, RequestAgentRunErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }, { scheme: 'bearer', type: 'http' }],
    url: '/agents/runs',
    ...options,
    headers: {

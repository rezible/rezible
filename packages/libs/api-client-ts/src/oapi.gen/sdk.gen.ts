 ...
 */
export const selectIntegrationInstallTargets = <ThrowOnError extends boolean = false>(options: Options<SelectIntegrationInstallTargetsData, ThrowOnError>) => (options.client ?? client).post<SelectIntegrationInstallTargetsResponses, SelectIntegrationInstallTargetsErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }, { scheme: 'bearer', type: 'http' }],

 ...
 */
export const updateOrganizationDetails = <ThrowOnError extends boolean = false>(options: Options<UpdateOrganizationDetailsData, ThrowOnError>) => (options.client ?? client).patch<UpdateOrganizationDetailsResponses, UpdateOrganizationDetailsErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }, { scheme: 'bearer', type: 'http' }],
    url: '/organizations/{id}',
    ...options,
    headers: {

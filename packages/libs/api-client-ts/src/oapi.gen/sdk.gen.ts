...
export const updateConfiguredIntegrationPreferences = <ThrowOnError extends boolean = false>(options: Options<UpdateConfiguredIntegrationPreferencesData, ThrowOnError>) => (options.client ?? client).post<UpdateConfiguredIntegrationPreferencesResponses, UpdateConfiguredIntegrationPreferencesErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }, { scheme: 'bearer', type: 'http' }],
    url: '/integrations/configured/{id}/preferences',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
...
export const configureIntegration = <ThrowOnError extends boolean = false>(options: Options<ConfigureIntegrationData, ThrowOnError>) => (options.client ?? client).post<ConfigureIntegrationResponses, ConfigureIntegrationErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }, { scheme: 'bearer', type: 'http' }],
    url: '/integrations/providers/{name}/configured',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
 ...
 */
export const selectIntegrationOauthFlow = <ThrowOnError extends boolean = false>(options: Options<SelectIntegrationOauthFlowData, ThrowOnError>) => (options.client ?? client).post<SelectIntegrationOauthFlowResponses, SelectIntegrationOauthFlowErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }, { scheme: 'bearer', type: 'http' }],
    url: '/integrations/providers/{name}/oauth/select',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
 ...
 */
export const getIntegrationDataSyncStatus = <ThrowOnError extends boolean = false>(options: Options<GetIntegrationDataSyncStatusData, ThrowOnError>) => (options.client ?? client).get<GetIntegrationDataSyncStatusResponses, GetIntegrationDataSyncStatusErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }, { scheme: 'bearer', type: 'http' }],
    url: '/integrations/providers/{name}/sync',
    ...options
});
 ...
 */
export const requestIntegrationDataSync = <ThrowOnError extends boolean = false>(options: Options<RequestIntegrationDataSyncData, ThrowOnError>) => (options.client ?? client).post<RequestIntegrationDataSyncResponses, RequestIntegrationDataSyncErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }, { scheme: 'bearer', type: 'http' }],
    url: '/integrations/providers/{name}/sync',
    ...options,
    headers: {

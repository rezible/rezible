 ...
 */
export const listAgentRunArtifacts = <ThrowOnError extends boolean = false>(options: Options<ListAgentRunArtifactsData, ThrowOnError>) => (options.client ?? client).get<ListAgentRunArtifactsResponses, ListAgentRunArtifactsErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }, { scheme: 'bearer', type: 'http' }],
 ...
 */
export const getIncidentContextPack = <ThrowOnError extends boolean = false>(options: Options<GetIncidentContextPackData, ThrowOnError>) => (options.client ?? client).get<GetIncidentContextPackResponses, GetIncidentContextPackErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }, { scheme: 'bearer', type: 'http' }],
 ...
 */
export const requestIncidentContextPackAgentRun = <ThrowOnError extends boolean = false>(options: Options<RequestIncidentContextPackAgentRunData, ThrowOnError>) => (options.client ?? client).post<RequestIncidentContextPackAgentRunResponses, RequestIncidentContextPackAgentRunErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }, { scheme: 'bearer', type: 'http' }],

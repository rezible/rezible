...
export const getInvestigationQueryKey = (options: Options<GetInvestigationData>) => createQueryKey('getInvestigation', options);

/**
 * Get Investigation
 */
export const getInvestigationOptions = (options: Options<GetInvestigationData>) => queryOptions<GetInvestigationResponse, GetInvestigationError, GetInvestigationResponse, ReturnType<typeof getInvestigationQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
    ...
    queryKey: getInvestigationQueryKey(options)
});

 ...
 */
export const completeOrgSetupMutation = (options?: Partial<Options<CompleteOrgSetupData>>): MutationOptions<CompleteOrgSetupResponse, CompleteOrgSetupError, Options<CompleteOrgSetupData>> => {
    const mutationOptions: MutationOptions<CompleteOrgSetupResponse, CompleteOrgSetupError, Options<CompleteOrgSetupData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await completeOrgSetup({
                ...options,
                ...fnOptions,
                throwOnError: true
            });

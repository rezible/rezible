...
export const listAiAgentRunsQueryKey = (options?: Options<ListAiAgentRunsData>) => createQueryKey('listAiAgentRuns', options);

/**
 * List Agent Runs
 */
export const listAiAgentRunsOptions = (options?: Options<ListAiAgentRunsData>) => queryOptions<ListAiAgentRunsResponse, ListAiAgentRunsError, ListAiAgentRunsResponse, ReturnType<typeof listAiAgentRunsQueryKey>>({
    ...
    queryKey: listAiAgentRunsQueryKey(options)
});
...
export const listAiAgentRunsInfiniteQueryKey = (options?: Options<ListAiAgentRunsData>): QueryKey<Options<ListAiAgentRunsData>> => createQueryKey('listAiAgentRuns', options, true);
 ...
 * Request Agent Run
 */
export const requestAiAgentRunMutation = (options?: Partial<Options<RequestAiAgentRunData>>): MutationOptions<RequestAiAgentRunResponse, RequestAiAgentRunError, Options<RequestAiAgentRunData>> => {
    const mutationOptions: MutationOptions<RequestAiAgentRunResponse, RequestAiAgentRunError, Options<RequestAiAgentRunData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await requestAiAgentRun({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const getAiAgentRunQueryKey = (options: Options<GetAiAgentRunData>) => createQueryKey('getAiAgentRun', options);

/**
 * Get an Agent Run
 */
export const getAiAgentRunOptions = (options: Options<GetAiAgentRunData>) => queryOptions<GetAiAgentRunResponse, GetAiAgentRunError, GetAiAgentRunResponse, ReturnType<typeof getAiAgentRunQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getAiAgentRun({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getAiAgentRunQueryKey(options)
});

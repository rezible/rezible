 ...
 */
export const getDocumentAccessMutation = (options?: Partial<Options<GetDocumentAccessData>>): MutationOptions<GetDocumentAccessResponse, GetDocumentAccessError, Options<GetDocumentAccessData>> => {
    const mutationOptions: MutationOptions<GetDocumentAccessResponse, GetDocumentAccessError, Options<GetDocumentAccessData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await getDocumentAccess({
                ...options,
                ...fnOptions,
                throwOnError: true
            });

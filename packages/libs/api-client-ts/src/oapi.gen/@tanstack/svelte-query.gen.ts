 ...
 */
export const updateOrganizationDetailsMutation = (options?: Partial<Options<UpdateOrganizationDetailsData>>): MutationOptions<UpdateOrganizationDetailsResponse, UpdateOrganizationDetailsError, Options<UpdateOrganizationDetailsData>> => {
    const mutationOptions: MutationOptions<UpdateOrganizationDetailsResponse, UpdateOrganizationDetailsError, Options<UpdateOrganizationDetailsData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await updateOrganizationDetails({
                ...options,
                ...fnOptions,
                throwOnError: true
            });

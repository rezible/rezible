 ...
 */
export const listSupportedIntegrations = <ThrowOnError extends boolean = false>(options?: Options<ListSupportedIntegrationsData, ThrowOnError>) => (options?.client ?? client).get<ListSupportedIntegrationsResponses, ListSupportedIntegrationsErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'rezible_auth',
            type: 'apiKey'
 ...
 */
export const deleteConfiguredIntegration = <ThrowOnError extends boolean = false>(options: Options<DeleteConfiguredIntegrationData, ThrowOnError>) => (options.client ?? client).delete<DeleteConfiguredIntegrationResponses, DeleteConfiguredIntegrationErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'rezible_auth',
            type: 'apiKey'
 ...
 */
export const updateConfiguredIntegration = <ThrowOnError extends boolean = false>(options: Options<UpdateConfiguredIntegrationData, ThrowOnError>) => (options.client ?? client).patch<UpdateConfiguredIntegrationResponses, UpdateConfiguredIntegrationErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'rezible_auth',
            type: 'apiKey'

...
/**
 * List Events For an Oncall Shift
 */
export const listOncallShiftEvents = <ThrowOnError extends boolean = false>(options: Options<ListOncallShiftEventsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ListOncallShiftEventsResponse, ListOncallShiftEventsError, ThrowOnError>({

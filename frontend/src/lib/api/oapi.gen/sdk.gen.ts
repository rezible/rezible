 ...
 */
export const listOncallEventAnnotations = <ThrowOnError extends boolean = false>(options?: Options<ListOncallEventAnnotationsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<ListOncallEventAnnotationsResponse, ListOncallEventAnnotationsError, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'rez_session',
...
/**
 * Create an Oncall Event Annotation
 */
export const createOncallEventAnnotation = <ThrowOnError extends boolean = false>(options: Options<CreateOncallEventAnnotationData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<CreateOncallEventAnnotationResponse, CreateOncallEventAnnotationError, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'rez_session',
 ...
 */
export const deleteOncallEventAnnotation = <ThrowOnError extends boolean = false>(options: Options<DeleteOncallEventAnnotationData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteOncallEventAnnotationResponse, DeleteOncallEventAnnotationError, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'rez_session',
 ...
 */
export const updateOncallEventAnnotation = <ThrowOnError extends boolean = false>(options: Options<UpdateOncallEventAnnotationData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<UpdateOncallEventAnnotationResponse, UpdateOncallEventAnnotationError, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'rez_session',

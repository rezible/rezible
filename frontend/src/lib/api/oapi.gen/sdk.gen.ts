 ...
 */
export const listIncidentEventContributingFactorCategories = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<ListIncidentEventContributingFactorCategoriesData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListIncidentEventContributingFactorCategoriesResponse, ListIncidentEventContributingFactorCategoriesError, ThrowOnError>({
        ...options,
 ...
 */
export const deleteIncidentEvent = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<DeleteIncidentEventData, ThrowOnError>) => {
    return (options?.client ?? client).delete<DeleteIncidentEventResponse, DeleteIncidentEventError, ThrowOnError>({
        ...options,
 ...
 */
export const listSystemComponentKinds = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<ListSystemComponentKindsData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListSystemComponentKindsResponse, ListSystemComponentKindsError, ThrowOnError>({
        ...options,
 ...
 */
export const createSystemComponentKind = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<CreateSystemComponentKindData, ThrowOnError>) => {
    return (options?.client ?? client).post<CreateSystemComponentKindResponse, CreateSystemComponentKindError, ThrowOnError>({
        ...options,
        url: '/system_component_kinds'
    });
};
 ...
 */
export const getSystemComponentKind = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetSystemComponentKindData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetSystemComponentKindResponse, GetSystemComponentKindError, ThrowOnError>({
        ...options,
 ...
 */
export const archiveSystemComponentKind = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ArchiveSystemComponentKindData, ThrowOnError>) => {
    return (options?.client ?? client).delete<ArchiveSystemComponentKindResponse, ArchiveSystemComponentKindError, ThrowOnError>({
        ...options,
        url: '/system_component_kinds/{id}'
    });
};
 ...
 */
export const updateSystemComponentKind = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UpdateSystemComponentKindData, ThrowOnError>) => {
    return (options?.client ?? client).patch<UpdateSystemComponentKindResponse, UpdateSystemComponentKindError, ThrowOnError>({
        ...options,
        url: '/system_component_kinds/{id}'
    });
};

...
/**
 * List System Components for Incident
 */
export const listIncidentSystemComponents = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ListIncidentSystemComponentsData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListIncidentSystemComponentsResponse, ListIncidentSystemComponentsError, ThrowOnError>({
        ...options,
        url: '/incidents/{id}/components'
    });
};
 ...
 */
export const archiveSystemComponentRelationship = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ArchiveSystemComponentRelationshipData, ThrowOnError>) => {
    return (options?.client ?? client).delete<ArchiveSystemComponentRelationshipResponse, ArchiveSystemComponentRelationshipError, ThrowOnError>({
        ...options,
 ...
 */
export const updateSystemComponentRelationship = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UpdateSystemComponentRelationshipData, ThrowOnError>) => {
    return (options?.client ?? client).patch<UpdateSystemComponentRelationshipResponse, UpdateSystemComponentRelationshipError, ThrowOnError>({
        ...options,
        url: '/system_component_relationships/{id}'
    });
};
...
/**
 * List relationships for a System Component
 */
export const listSystemComponentRelationships = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ListSystemComponentRelationshipsData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListSystemComponentRelationshipsResponse, ListSystemComponentRelationshipsError, ThrowOnError>({
        ...options,
        url: '/system_components/{id}/relationships'
    });
};
 ...
 */
export const createSystemComponentRelationship = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<CreateSystemComponentRelationshipData, ThrowOnError>) => {
    return (options?.client ?? client).post<CreateSystemComponentRelationshipResponse, CreateSystemComponentRelationshipError, ThrowOnError>({
        ...options,
        url: '/system_components/{id}/relationships'
    });
};

 ...
 */
export const archiveIncidentMilestone = <ThrowOnError extends boolean = false>(options: Options<ArchiveIncidentMilestoneData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<ArchiveIncidentMilestoneResponse, ArchiveIncidentMilestoneError, ThrowOnError>({

...
import type {
	...
	GetIncidentDebriefData,
	UpdateIncidentDebriefData,
	UpdateIncidentDebriefError,
	UpdateIncidentDebriefResponse,
	ListDebriefMessagesData,
	...
	GetIncidentFieldData,
	ArchiveIncidentFieldData,
	...
	GetRetrospectiveDiscussionData,
	...
	ListSystemAnalysisComponentsData,
...
import {
	client,
	listDebriefQuestions,
	createDebriefQuestion,
	getDebriefQuestion,
	archiveDebriefQuestion,
	updateDebriefQuestion,
	requestDocumentEditorSession,
	verifyDocumentEditorSession,
	listEnvironments,
	createEnvironment,
	getEnvironment,
	archiveEnvironment,
	...
	updateFunctionality,
	getIncidentDebrief,
	updateIncidentDebrief,
	listDebriefMessages,
	addIncidentDebriefUserMessage,
	listDebriefSuggestions,
	listIncidentFields,
	createIncidentField,
	getIncidentField,
	archiveIncidentField,
	updateIncidentField,
	archiveIncidentMilestone,
	updateIncidentMilestone,
	listIncidentRoles,
	createIncidentRole,
	getIncidentRole,
	archiveIncidentRole,
	...
	archiveIncident,
	updateIncident,
	getIncidentUserDebrief,
	listIncidentMilestones,
	createIncidentMilestone,
	getRetrospectiveForIncident,
	listIntegrations,
	createIntegration,
	getIntegration,
	archiveIntegration,
	...
	archiveOncallShiftAnnotation,
	updateOncallShiftAnnotation,
	createOncallHandoverTemplate,
	getOncallShiftHandoverTemplate,
	archiveOncallHandoverTemplate,
	updateOncallHandoverTemplate,
	listOncallRosters,
	getOncallRoster,
	listOncallShifts,
	getOncallShift,
	listOncallShiftAlerts,
	listOncallShiftAnnotations,
	createOncallShiftAnnotation,
	getOncallShiftHandover,
	sendOncallShiftHandover,
	listOncallShiftIncidents,
	getNextOncallShift,
	getUserOncallDetails,
	archiveRetrospectiveReview,
	updateRetrospectiveReview,
	listRetrospectives,
	getRetrospective,
	listRetrospectiveDiscussions,
	createRetrospectiveDiscussion,
	getRetrospectiveDiscussion,
	addRetrospectiveDiscussionReply,
	updateRetrospectiveDiscussion,
	listRetrospectiveReviews,
	createRetrospectiveReview,
	getSystemAnalysisComponent,
	deleteSystemAnalysisComponent,
	updateSystemAnalysisComponent,
	getSystemAnalysisRelationship,
	deleteSystemAnalysisRelationship,
	updateSystemAnalysisRelationship,
	getSystemAnalysis,
	listSystemAnalysisComponents,
	addSystemAnalysisComponent,
	listSystemAnalysisRelationships,
	createSystemAnalysisRelationship,
...
export const listDebriefQuestionsInfiniteQueryKey = (
	options?: OptionsLegacyParser<ListDebriefQuestionsData>
): QueryKey<OptionsLegacyParser<ListDebriefQuestionsData>> => [
...
export const listDebriefQuestionsInfiniteOptions = (
	...
	return infiniteQueryOptions<
		ListDebriefQuestionsResponse,
		ListDebriefQuestionsError,
		InfiniteData<ListDebriefQuestionsResponse>,
		QueryKey<OptionsLegacyParser<ListDebriefQuestionsData>>,
		| number
		| Pick<
				QueryKey<OptionsLegacyParser<ListDebriefQuestionsData>>[0],
				"body" | "headers" | "path" | "query"
		  >
	>(
		// @ts-ignore
...
export const createDebriefQuestionMutation = (
	options?: Partial<OptionsLegacyParser<CreateDebriefQuestionData>>
) => {
	const mutationOptions: MutationOptions<
		CreateDebriefQuestionResponse,
		CreateDebriefQuestionError,
		OptionsLegacyParser<CreateDebriefQuestionData>
	> = {
...
export const archiveDebriefQuestionMutation = (
	options?: Partial<OptionsLegacyParser<ArchiveDebriefQuestionData>>
) => {
	const mutationOptions: MutationOptions<
		ArchiveDebriefQuestionResponse,
		ArchiveDebriefQuestionError,
		OptionsLegacyParser<ArchiveDebriefQuestionData>
	> = {
		mutationFn: async (localOptions) => {
...
export const updateDebriefQuestionMutation = (
	options?: Partial<OptionsLegacyParser<UpdateDebriefQuestionData>>
) => {
	const mutationOptions: MutationOptions<
		UpdateDebriefQuestionResponse,
		UpdateDebriefQuestionError,
		OptionsLegacyParser<UpdateDebriefQuestionData>
	> = {
		mutationFn: async (localOptions) => {
...
export const requestDocumentEditorSessionQueryKey = (
	options: OptionsLegacyParser<RequestDocumentEditorSessionData>
) => [createQueryKey("requestDocumentEditorSession", options)];

export const requestDocumentEditorSessionOptions = (
	options: OptionsLegacyParser<RequestDocumentEditorSessionData>
) => {
	return queryOptions({
		queryFn: async ({ queryKey, signal }) => {
...
export const requestDocumentEditorSessionMutation = (
	options?: Partial<OptionsLegacyParser<RequestDocumentEditorSessionData>>
) => {
	const mutationOptions: MutationOptions<
		RequestDocumentEditorSessionResponse,
		RequestDocumentEditorSessionError,
		OptionsLegacyParser<RequestDocumentEditorSessionData>
	> = {
		mutationFn: async (localOptions) => {
			const { data } = await requestDocumentEditorSession({
				...options,
...
export const verifyDocumentEditorSessionQueryKey = (
	options: OptionsLegacyParser<VerifyDocumentEditorSessionData>
) => [createQueryKey("verifyDocumentEditorSession", options)];

export const verifyDocumentEditorSessionOptions = (
	options: OptionsLegacyParser<VerifyDocumentEditorSessionData>
) => {
	return queryOptions({
		queryFn: async ({ queryKey, signal }) => {
...
export const verifyDocumentEditorSessionMutation = (
	options?: Partial<OptionsLegacyParser<VerifyDocumentEditorSessionData>>
) => {
	const mutationOptions: MutationOptions<
		VerifyDocumentEditorSessionResponse,
		VerifyDocumentEditorSessionError,
		OptionsLegacyParser<VerifyDocumentEditorSessionData>
	> = {
		mutationFn: async (localOptions) => {
			const { data } = await verifyDocumentEditorSession({
				...options,
...
export const createEnvironmentMutation = (
	...
	const mutationOptions: MutationOptions<
		CreateEnvironmentResponse,
		CreateEnvironmentError,
		OptionsLegacyParser<CreateEnvironmentData>
	> = {
		mutationFn: async (localOptions) => {
			const { data } = await createEnvironment({
				...options,
...
export const archiveEnvironmentMutation = (
	options?: Partial<OptionsLegacyParser<ArchiveEnvironmentData>>
) => {
	const mutationOptions: MutationOptions<
		ArchiveEnvironmentResponse,
		ArchiveEnvironmentError,
		OptionsLegacyParser<ArchiveEnvironmentData>
	> = {
		mutationFn: async (localOptions) => {
...
export const updateEnvironmentMutation = (
	...
	const mutationOptions: MutationOptions<
		UpdateEnvironmentResponse,
		UpdateEnvironmentError,
		OptionsLegacyParser<UpdateEnvironmentData>
	> = {
		mutationFn: async (localOptions) => {
...
export const listFunctionalitiesInfiniteQueryKey = (
	options?: OptionsLegacyParser<ListFunctionalitiesData>
): QueryKey<OptionsLegacyParser<ListFunctionalitiesData>> => [
	createQueryKey("listFunctionalities", options, true),
];

export const listFunctionalitiesInfiniteOptions = (
	options?: OptionsLegacyParser<ListFunctionalitiesData>
) => {
	return infiniteQueryOptions<
		ListFunctionalitiesResponse,
		ListFunctionalitiesError,
		InfiniteData<ListFunctionalitiesResponse>,
		QueryKey<OptionsLegacyParser<ListFunctionalitiesData>>,
		| number
		| Pick<
				QueryKey<OptionsLegacyParser<ListFunctionalitiesData>>[0],
				"body" | "headers" | "path" | "query"
		  >
	>(
		// @ts-ignore
...
export const createFunctionalityMutation = (
	options?: Partial<OptionsLegacyParser<CreateFunctionalityData>>
) => {
	const mutationOptions: MutationOptions<
		CreateFunctionalityResponse,
		CreateFunctionalityError,
		OptionsLegacyParser<CreateFunctionalityData>
	> = {
		mutationFn: async (localOptions) => {
			const { data } = await createFunctionality({
				...options,
...
export const archiveFunctionalityMutation = (
	options?: Partial<OptionsLegacyParser<ArchiveFunctionalityData>>
) => {
	const mutationOptions: MutationOptions<
		ArchiveFunctionalityResponse,
		ArchiveFunctionalityError,
		OptionsLegacyParser<ArchiveFunctionalityData>
	> = {
		mutationFn: async (localOptions) => {
...
export const updateFunctionalityMutation = (
	options?: Partial<OptionsLegacyParser<UpdateFunctionalityData>>
) => {
	const mutationOptions: MutationOptions<
		UpdateFunctionalityResponse,
		UpdateFunctionalityError,
		OptionsLegacyParser<UpdateFunctionalityData>
	> = {
		mutationFn: async (localOptions) => {
...
export const updateIncidentDebriefMutation = (
	options?: Partial<OptionsLegacyParser<UpdateIncidentDebriefData>>
) => {
	const mutationOptions: MutationOptions<
		UpdateIncidentDebriefResponse,
		UpdateIncidentDebriefError,
		OptionsLegacyParser<UpdateIncidentDebriefData>
	> = {
		mutationFn: async (localOptions) => {
...
export const listDebriefMessagesInfiniteQueryKey = (
	options: OptionsLegacyParser<ListDebriefMessagesData>
): QueryKey<OptionsLegacyParser<ListDebriefMessagesData>> => [
...
export const listDebriefMessagesInfiniteOptions = (
	...
	return infiniteQueryOptions<
		ListDebriefMessagesResponse,
		ListDebriefMessagesError,
		InfiniteData<ListDebriefMessagesResponse>,
		QueryKey<OptionsLegacyParser<ListDebriefMessagesData>>,
		| number
		| Pick<
				QueryKey<OptionsLegacyParser<ListDebriefMessagesData>>[0],
				"body" | "headers" | "path" | "query"
		  >
	>(
		// @ts-ignore
...
export const addIncidentDebriefUserMessageQueryKey = (
	options: OptionsLegacyParser<AddIncidentDebriefUserMessageData>
) => [createQueryKey("addIncidentDebriefUserMessage", options)];

export const addIncidentDebriefUserMessageOptions = (
	options: OptionsLegacyParser<AddIncidentDebriefUserMessageData>
) => {
	return queryOptions({
		queryFn: async ({ queryKey, signal }) => {
...
export const addIncidentDebriefUserMessageMutation = (
	options?: Partial<OptionsLegacyParser<AddIncidentDebriefUserMessageData>>
) => {
	const mutationOptions: MutationOptions<
		AddIncidentDebriefUserMessageResponse,
		AddIncidentDebriefUserMessageError,
		OptionsLegacyParser<AddIncidentDebriefUserMessageData>
	> = {
		mutationFn: async (localOptions) => {
			const { data } = await addIncidentDebriefUserMessage({
				...options,
...
export const listDebriefSuggestionsInfiniteQueryKey = (
	options: OptionsLegacyParser<ListDebriefSuggestionsData>
): QueryKey<OptionsLegacyParser<ListDebriefSuggestionsData>> => [
	createQueryKey("listDebriefSuggestions", options, true),
];

export const listDebriefSuggestionsInfiniteOptions = (
	options: OptionsLegacyParser<ListDebriefSuggestionsData>
) => {
	return infiniteQueryOptions<
		ListDebriefSuggestionsResponse,
...
export const listIncidentFieldsInfiniteQueryKey = (
	options?: OptionsLegacyParser<ListIncidentFieldsData>
): QueryKey<OptionsLegacyParser<ListIncidentFieldsData>> => [
...
export const listIncidentFieldsInfiniteOptions = (
	...
	return infiniteQueryOptions<
		ListIncidentFieldsResponse,
		ListIncidentFieldsError,
		InfiniteData<ListIncidentFieldsResponse>,
		QueryKey<OptionsLegacyParser<ListIncidentFieldsData>>,
		| number
		| Pick<
				QueryKey<OptionsLegacyParser<ListIncidentFieldsData>>[0],
				"body" | "headers" | "path" | "query"
		  >
	>(
		// @ts-ignore
...
export const createIncidentFieldMutation = (
	options?: Partial<OptionsLegacyParser<CreateIncidentFieldData>>
) => {
	const mutationOptions: MutationOptions<
		CreateIncidentFieldResponse,
		CreateIncidentFieldError,
		OptionsLegacyParser<CreateIncidentFieldData>
	> = {
		mutationFn: async (localOptions) => {
			const { data } = await createIncidentField({
				...options,
...
export const archiveIncidentFieldMutation = (
	options?: Partial<OptionsLegacyParser<ArchiveIncidentFieldData>>
) => {
	const mutationOptions: MutationOptions<
		ArchiveIncidentFieldResponse,
		ArchiveIncidentFieldError,
		OptionsLegacyParser<ArchiveIncidentFieldData>
	> = {
		mutationFn: async (localOptions) => {
...
export const updateIncidentFieldMutation = (
	options?: Partial<OptionsLegacyParser<UpdateIncidentFieldData>>
) => {
	const mutationOptions: MutationOptions<
		UpdateIncidentFieldResponse,
		UpdateIncidentFieldError,
		OptionsLegacyParser<UpdateIncidentFieldData>
	> = {
		mutationFn: async (localOptions) => {
...
export const archiveIncidentMilestoneMutation = (
	options?: Partial<OptionsLegacyParser<ArchiveIncidentMilestoneData>>
) => {
	const mutationOptions: MutationOptions<
		ArchiveIncidentMilestoneResponse,
		ArchiveIncidentMilestoneError,
		OptionsLegacyParser<ArchiveIncidentMilestoneData>
	> = {
		mutationFn: async (localOptions) => {
...
export const updateIncidentMilestoneMutation = (
	options?: Partial<OptionsLegacyParser<UpdateIncidentMilestoneData>>
) => {
	const mutationOptions: MutationOptions<
		UpdateIncidentMilestoneResponse,
		UpdateIncidentMilestoneError,
		OptionsLegacyParser<UpdateIncidentMilestoneData>
	> = {
		mutationFn: async (localOptions) => {
...
export const listIncidentRolesInfiniteQueryKey = (
	options?: OptionsLegacyParser<ListIncidentRolesData>
...
export const createIncidentRoleMutation = (
	options?: Partial<OptionsLegacyParser<CreateIncidentRoleData>>
) => {
	const mutationOptions: MutationOptions<
		CreateIncidentRoleResponse,
		CreateIncidentRoleError,
		OptionsLegacyParser<CreateIncidentRoleData>
	> = {
		mutationFn: async (localOptions) => {
			const { data } = await createIncidentRole({
				...options,
...
export const archiveIncidentRoleMutation = (
	options?: Partial<OptionsLegacyParser<ArchiveIncidentRoleData>>
) => {
	const mutationOptions: MutationOptions<
		ArchiveIncidentRoleResponse,
		ArchiveIncidentRoleError,
		OptionsLegacyParser<ArchiveIncidentRoleData>
	> = {
		mutationFn: async (localOptions) => {
...
export const updateIncidentRoleMutation = (
	options?: Partial<OptionsLegacyParser<UpdateIncidentRoleData>>
) => {
	const mutationOptions: MutationOptions<
		UpdateIncidentRoleResponse,
		UpdateIncidentRoleError,
		OptionsLegacyParser<UpdateIncidentRoleData>
	> = {
		mutationFn: async (localOptions) => {
...
export const listIncidentSeveritiesInfiniteQueryKey = (
	options?: OptionsLegacyParser<ListIncidentSeveritiesData>
): QueryKey<OptionsLegacyParser<ListIncidentSeveritiesData>> => [
...
export const listIncidentSeveritiesInfiniteOptions = (
	...
	return infiniteQueryOptions<
		ListIncidentSeveritiesResponse,
		ListIncidentSeveritiesError,
		InfiniteData<ListIncidentSeveritiesResponse>,
		QueryKey<OptionsLegacyParser<ListIncidentSeveritiesData>>,
		| number
		| Pick<
...
export const createIncidentSeverityMutation = (
	options?: Partial<OptionsLegacyParser<CreateIncidentSeverityData>>
) => {
	const mutationOptions: MutationOptions<
		CreateIncidentSeverityResponse,
		CreateIncidentSeverityError,
		OptionsLegacyParser<CreateIncidentSeverityData>
	> = {
		mutationFn: async (localOptions) => {
			const { data } = await createIncidentSeverity({
				...options,
...
export const archiveIncidentSeverityMutation = (
	options?: Partial<OptionsLegacyParser<ArchiveIncidentSeverityData>>
) => {
	const mutationOptions: MutationOptions<
		ArchiveIncidentSeverityResponse,
		ArchiveIncidentSeverityError,
		OptionsLegacyParser<ArchiveIncidentSeverityData>
	> = {
		mutationFn: async (localOptions) => {
...
export const updateIncidentSeverityMutation = (
	options?: Partial<OptionsLegacyParser<UpdateIncidentSeverityData>>
) => {
	const mutationOptions: MutationOptions<
		UpdateIncidentSeverityResponse,
		UpdateIncidentSeverityError,
		OptionsLegacyParser<UpdateIncidentSeverityData>
	> = {
		mutationFn: async (localOptions) => {
...
export const createIncidentTagMutation = (
	...
	const mutationOptions: MutationOptions<
		CreateIncidentTagResponse,
		CreateIncidentTagError,
		OptionsLegacyParser<CreateIncidentTagData>
	> = {
		mutationFn: async (localOptions) => {
			const { data } = await createIncidentTag({
				...options,
...
export const archiveIncidentTagMutation = (
	options?: Partial<OptionsLegacyParser<ArchiveIncidentTagData>>
) => {
	const mutationOptions: MutationOptions<
		ArchiveIncidentTagResponse,
		ArchiveIncidentTagError,
		OptionsLegacyParser<ArchiveIncidentTagData>
	> = {
		mutationFn: async (localOptions) => {
...
export const updateIncidentTagMutation = (
	...
	const mutationOptions: MutationOptions<
		UpdateIncidentTagResponse,
		UpdateIncidentTagError,
		OptionsLegacyParser<UpdateIncidentTagData>
	> = {
		mutationFn: async (localOptions) => {
...
export const listIncidentTypesInfiniteQueryKey = (
	options?: OptionsLegacyParser<ListIncidentTypesData>
...
export const createIncidentTypeMutation = (
	options?: Partial<OptionsLegacyParser<CreateIncidentTypeData>>
) => {
	const mutationOptions: MutationOptions<
		CreateIncidentTypeResponse,
		CreateIncidentTypeError,
		OptionsLegacyParser<CreateIncidentTypeData>
	> = {
		mutationFn: async (localOptions) => {
			const { data } = await createIncidentType({
				...options,
...
export const archiveIncidentTypeMutation = (
	options?: Partial<OptionsLegacyParser<ArchiveIncidentTypeData>>
) => {
	const mutationOptions: MutationOptions<
		ArchiveIncidentTypeResponse,
		ArchiveIncidentTypeError,
		OptionsLegacyParser<ArchiveIncidentTypeData>
	> = {
		mutationFn: async (localOptions) => {
...
export const updateIncidentTypeMutation = (
	options?: Partial<OptionsLegacyParser<UpdateIncidentTypeData>>
) => {
	const mutationOptions: MutationOptions<
		UpdateIncidentTypeResponse,
		UpdateIncidentTypeError,
		OptionsLegacyParser<UpdateIncidentTypeData>
	> = {
		mutationFn: async (localOptions) => {
...
export const createIncidentMutation = (
	...
	const mutationOptions: MutationOptions<
		CreateIncidentResponse,
		CreateIncidentError,
		OptionsLegacyParser<CreateIncidentData>
	> = {
		mutationFn: async (localOptions) => {
			const { data } = await createIncident({
				...options,
...
export const archiveIncidentMutation = (
	...
	const mutationOptions: MutationOptions<
		ArchiveIncidentResponse,
		ArchiveIncidentError,
		OptionsLegacyParser<ArchiveIncidentData>
	> = {
		mutationFn: async (localOptions) => {
...
export const updateIncidentMutation = (
	...
	const mutationOptions: MutationOptions<
		UpdateIncidentResponse,
		UpdateIncidentError,
		OptionsLegacyParser<UpdateIncidentData>
	> = {
		mutationFn: async (localOptions) => {
...
export const createIncidentMilestoneQueryKey = (
...
export const createIncidentMilestoneMutation = (
	options?: Partial<OptionsLegacyParser<CreateIncidentMilestoneData>>
) => {
	const mutationOptions: MutationOptions<
		CreateIncidentMilestoneResponse,
		CreateIncidentMilestoneError,
		OptionsLegacyParser<CreateIncidentMilestoneData>
	> = {
		mutationFn: async (localOptions) => {
			const { data } = await createIncidentMilestone({
				...options,
...
export const getRetrospectiveForIncidentQueryKey = (
	options: OptionsLegacyParser<GetRetrospectiveForIncidentData>
) => [createQueryKey("getRetrospectiveForIncident", options)];

export const getRetrospectiveForIncidentOptions = (
	options: OptionsLegacyParser<GetRetrospectiveForIncidentData>
) => {
	return queryOptions({
		queryFn: async ({ queryKey, signal }) => {
...
export const createIntegrationMutation = (
	...
	const mutationOptions: MutationOptions<
		CreateIntegrationResponse,
		CreateIntegrationError,
		OptionsLegacyParser<CreateIntegrationData>
	> = {
		mutationFn: async (localOptions) => {
			const { data } = await createIntegration({
				...options,
...
export const archiveIntegrationMutation = (
	options?: Partial<OptionsLegacyParser<ArchiveIntegrationData>>
) => {
	const mutationOptions: MutationOptions<
		ArchiveIntegrationResponse,
		ArchiveIntegrationError,
		OptionsLegacyParser<ArchiveIntegrationData>
	> = {
		mutationFn: async (localOptions) => {
...
export const updateIntegrationMutation = (
	...
	const mutationOptions: MutationOptions<
		UpdateIntegrationResponse,
		UpdateIntegrationError,
		OptionsLegacyParser<UpdateIntegrationData>
	> = {
		mutationFn: async (localOptions) => {
...
export const listMeetingSchedulesInfiniteQueryKey = (
	options?: OptionsLegacyParser<ListMeetingSchedulesData>
): QueryKey<OptionsLegacyParser<ListMeetingSchedulesData>> => [
	createQueryKey("listMeetingSchedules", options, true),
];

export const listMeetingSchedulesInfiniteOptions = (
	options?: OptionsLegacyParser<ListMeetingSchedulesData>
) => {
	return infiniteQueryOptions<
		ListMeetingSchedulesResponse,
		ListMeetingSchedulesError,
		InfiniteData<ListMeetingSchedulesResponse>,
		QueryKey<OptionsLegacyParser<ListMeetingSchedulesData>>,
		| number
		| Pick<
				QueryKey<OptionsLegacyParser<ListMeetingSchedulesData>>[0],
				"body" | "headers" | "path" | "query"
		  >
	>(
		// @ts-ignore
...
export const createMeetingScheduleMutation = (
	options?: Partial<OptionsLegacyParser<CreateMeetingScheduleData>>
) => {
	const mutationOptions: MutationOptions<
		CreateMeetingScheduleResponse,
		CreateMeetingScheduleError,
		OptionsLegacyParser<CreateMeetingScheduleData>
	> = {
		mutationFn: async (localOptions) => {
			const { data } = await createMeetingSchedule({
				...options,
...
export const archiveMeetingScheduleMutation = (
	options?: Partial<OptionsLegacyParser<ArchiveMeetingScheduleData>>
) => {
	const mutationOptions: MutationOptions<
		ArchiveMeetingScheduleResponse,
		ArchiveMeetingScheduleError,
		OptionsLegacyParser<ArchiveMeetingScheduleData>
	> = {
		mutationFn: async (localOptions) => {
...
export const updateMeetingScheduleMutation = (
	options?: Partial<OptionsLegacyParser<UpdateMeetingScheduleData>>
) => {
	const mutationOptions: MutationOptions<
		UpdateMeetingScheduleResponse,
		UpdateMeetingScheduleError,
		OptionsLegacyParser<UpdateMeetingScheduleData>
	> = {
		mutationFn: async (localOptions) => {
...
export const listMeetingSessionsInfiniteQueryKey = (
	options?: OptionsLegacyParser<ListMeetingSessionsData>
): QueryKey<OptionsLegacyParser<ListMeetingSessionsData>> => [
	createQueryKey("listMeetingSessions", options, true),
];

export const listMeetingSessionsInfiniteOptions = (
	options?: OptionsLegacyParser<ListMeetingSessionsData>
) => {
	return infiniteQueryOptions<
		ListMeetingSessionsResponse,
		ListMeetingSessionsError,
		InfiniteData<ListMeetingSessionsResponse>,
		QueryKey<OptionsLegacyParser<ListMeetingSessionsData>>,
		| number
		| Pick<
				QueryKey<OptionsLegacyParser<ListMeetingSessionsData>>[0],
				"body" | "headers" | "path" | "query"
		  >
	>(
		// @ts-ignore
...
export const createMeetingSessionMutation = (
	options?: Partial<OptionsLegacyParser<CreateMeetingSessionData>>
) => {
	const mutationOptions: MutationOptions<
		CreateMeetingSessionResponse,
		CreateMeetingSessionError,
		OptionsLegacyParser<CreateMeetingSessionData>
	> = {
		mutationFn: async (localOptions) => {
			const { data } = await createMeetingSession({
				...options,
...
export const archiveMeetingSessionMutation = (
	options?: Partial<OptionsLegacyParser<ArchiveMeetingSessionData>>
) => {
	const mutationOptions: MutationOptions<
		ArchiveMeetingSessionResponse,
		ArchiveMeetingSessionError,
		OptionsLegacyParser<ArchiveMeetingSessionData>
	> = {
		mutationFn: async (localOptions) => {
...
export const updateMeetingSessionMutation = (
	options?: Partial<OptionsLegacyParser<UpdateMeetingSessionData>>
) => {
	const mutationOptions: MutationOptions<
		UpdateMeetingSessionResponse,
		UpdateMeetingSessionError,
		OptionsLegacyParser<UpdateMeetingSessionData>
	> = {
		mutationFn: async (localOptions) => {
...
export const archiveOncallShiftAnnotationMutation = (
	options?: Partial<OptionsLegacyParser<ArchiveOncallShiftAnnotationData>>
) => {
	const mutationOptions: MutationOptions<
		ArchiveOncallShiftAnnotationResponse,
		ArchiveOncallShiftAnnotationError,
		OptionsLegacyParser<ArchiveOncallShiftAnnotationData>
	> = {
		mutationFn: async (localOptions) => {
...
export const updateOncallShiftAnnotationMutation = (
	options?: Partial<OptionsLegacyParser<UpdateOncallShiftAnnotationData>>
) => {
	const mutationOptions: MutationOptions<
		UpdateOncallShiftAnnotationResponse,
		UpdateOncallShiftAnnotationError,
		OptionsLegacyParser<UpdateOncallShiftAnnotationData>
	> = {
		mutationFn: async (localOptions) => {
...
export const createOncallHandoverTemplateQueryKey = (
	options: OptionsLegacyParser<CreateOncallHandoverTemplateData>
) => [createQueryKey("createOncallHandoverTemplate", options)];

export const createOncallHandoverTemplateOptions = (
	options: OptionsLegacyParser<CreateOncallHandoverTemplateData>
) => {
	return queryOptions({
		queryFn: async ({ queryKey, signal }) => {
...
export const createOncallHandoverTemplateMutation = (
	options?: Partial<OptionsLegacyParser<CreateOncallHandoverTemplateData>>
) => {
	const mutationOptions: MutationOptions<
		CreateOncallHandoverTemplateResponse,
		CreateOncallHandoverTemplateError,
		OptionsLegacyParser<CreateOncallHandoverTemplateData>
	> = {
		mutationFn: async (localOptions) => {
			const { data } = await createOncallHandoverTemplate({
				...options,
...
export const getOncallShiftHandoverTemplateQueryKey = (
	options: OptionsLegacyParser<GetOncallShiftHandoverTemplateData>
) => [createQueryKey("getOncallShiftHandoverTemplate", options)];

export const getOncallShiftHandoverTemplateOptions = (
	options: OptionsLegacyParser<GetOncallShiftHandoverTemplateData>
) => {
	return queryOptions({
		queryFn: async ({ queryKey, signal }) => {
...
export const archiveOncallHandoverTemplateMutation = (
	options?: Partial<OptionsLegacyParser<ArchiveOncallHandoverTemplateData>>
) => {
	const mutationOptions: MutationOptions<
		ArchiveOncallHandoverTemplateResponse,
		ArchiveOncallHandoverTemplateError,
		OptionsLegacyParser<ArchiveOncallHandoverTemplateData>
	> = {
		mutationFn: async (localOptions) => {
...
export const updateOncallHandoverTemplateMutation = (
	options?: Partial<OptionsLegacyParser<UpdateOncallHandoverTemplateData>>
) => {
	const mutationOptions: MutationOptions<
		UpdateOncallHandoverTemplateResponse,
		UpdateOncallHandoverTemplateError,
		OptionsLegacyParser<UpdateOncallHandoverTemplateData>
	> = {
		mutationFn: async (localOptions) => {
...
export const listOncallRostersInfiniteQueryKey = (
	options?: OptionsLegacyParser<ListOncallRostersData>
...
export const listOncallShiftAlertsInfiniteQueryKey = (
	options: OptionsLegacyParser<ListOncallShiftAlertsData>
): QueryKey<OptionsLegacyParser<ListOncallShiftAlertsData>> => [
	createQueryKey("listOncallShiftAlerts", options, true),
];

export const listOncallShiftAlertsInfiniteOptions = (
	options: OptionsLegacyParser<ListOncallShiftAlertsData>
) => {
	return infiniteQueryOptions<
		ListOncallShiftAlertsResponse,
		ListOncallShiftAlertsError,
		InfiniteData<ListOncallShiftAlertsResponse>,
		QueryKey<OptionsLegacyParser<ListOncallShiftAlertsData>>,
		| number
		| Pick<
				QueryKey<OptionsLegacyParser<ListOncallShiftAlertsData>>[0],
				"body" | "headers" | "path" | "query"
		  >
	>(
		// @ts-ignore
...
export const listOncallShiftAnnotationsQueryKey = (
	options: OptionsLegacyParser<ListOncallShiftAnnotationsData>
) => [createQueryKey("listOncallShiftAnnotations", options)];

export const listOncallShiftAnnotationsOptions = (
	options: OptionsLegacyParser<ListOncallShiftAnnotationsData>
) => {
	return queryOptions({
		queryFn: async ({ queryKey, signal }) => {
...
export const listOncallShiftAnnotationsInfiniteQueryKey = (
	options: OptionsLegacyParser<ListOncallShiftAnnotationsData>
...
export const listOncallShiftAnnotationsInfiniteOptions = (
	...
	return infiniteQueryOptions<
		ListOncallShiftAnnotationsResponse,
		ListOncallShiftAnnotationsError,
		InfiniteData<ListOncallShiftAnnotationsResponse>,
		QueryKey<OptionsLegacyParser<ListOncallShiftAnnotationsData>>,
		| number
		| Pick<
				QueryKey<
...
export const createOncallShiftAnnotationQueryKey = (
	options: OptionsLegacyParser<CreateOncallShiftAnnotationData>
) => [createQueryKey("createOncallShiftAnnotation", options)];

export const createOncallShiftAnnotationOptions = (
	options: OptionsLegacyParser<CreateOncallShiftAnnotationData>
) => {
	return queryOptions({
		queryFn: async ({ queryKey, signal }) => {
...
export const createOncallShiftAnnotationMutation = (
	options?: Partial<OptionsLegacyParser<CreateOncallShiftAnnotationData>>
) => {
	const mutationOptions: MutationOptions<
		CreateOncallShiftAnnotationResponse,
		CreateOncallShiftAnnotationError,
		OptionsLegacyParser<CreateOncallShiftAnnotationData>
	> = {
		mutationFn: async (localOptions) => {
			const { data } = await createOncallShiftAnnotation({
				...options,
...
export const sendOncallShiftHandoverQueryKey = (
...
export const sendOncallShiftHandoverMutation = (
	options?: Partial<OptionsLegacyParser<SendOncallShiftHandoverData>>
) => {
	const mutationOptions: MutationOptions<
		SendOncallShiftHandoverResponse,
		SendOncallShiftHandoverError,
		OptionsLegacyParser<SendOncallShiftHandoverData>
	> = {
		mutationFn: async (localOptions) => {
			const { data } = await sendOncallShiftHandover({
				...options,
...
export const listOncallShiftIncidentsQueryKey = (
	options: OptionsLegacyParser<ListOncallShiftIncidentsData>
) => [createQueryKey("listOncallShiftIncidents", options)];

export const listOncallShiftIncidentsOptions = (
	options: OptionsLegacyParser<ListOncallShiftIncidentsData>
) => {
	return queryOptions({
		queryFn: async ({ queryKey, signal }) => {
...
export const listOncallShiftIncidentsInfiniteQueryKey = (
	options: OptionsLegacyParser<ListOncallShiftIncidentsData>
): QueryKey<OptionsLegacyParser<ListOncallShiftIncidentsData>> => [
	createQueryKey("listOncallShiftIncidents", options, true),
];

export const listOncallShiftIncidentsInfiniteOptions = (
	options: OptionsLegacyParser<ListOncallShiftIncidentsData>
) => {
	return infiniteQueryOptions<
		ListOncallShiftIncidentsResponse,
		ListOncallShiftIncidentsError,
		InfiniteData<ListOncallShiftIncidentsResponse>,
		QueryKey<OptionsLegacyParser<ListOncallShiftIncidentsData>>,
		| number
		| Pick<
...
export const archiveRetrospectiveReviewMutation = (
	options?: Partial<OptionsLegacyParser<ArchiveRetrospectiveReviewData>>
) => {
	const mutationOptions: MutationOptions<
		ArchiveRetrospectiveReviewResponse,
		ArchiveRetrospectiveReviewError,
		OptionsLegacyParser<ArchiveRetrospectiveReviewData>
	> = {
		mutationFn: async (localOptions) => {
...
export const updateRetrospectiveReviewMutation = (
	options?: Partial<OptionsLegacyParser<UpdateRetrospectiveReviewData>>
) => {
	const mutationOptions: MutationOptions<
		UpdateRetrospectiveReviewResponse,
		UpdateRetrospectiveReviewError,
		OptionsLegacyParser<UpdateRetrospectiveReviewData>
	> = {
		mutationFn: async (localOptions) => {
...
export const listRetrospectivesInfiniteQueryKey = (
	options?: OptionsLegacyParser<ListRetrospectivesData>
): QueryKey<OptionsLegacyParser<ListRetrospectivesData>> => [
...
export const listRetrospectivesInfiniteOptions = (
	...
	return infiniteQueryOptions<
		ListRetrospectivesResponse,
		ListRetrospectivesError,
		InfiniteData<ListRetrospectivesResponse>,
		QueryKey<OptionsLegacyParser<ListRetrospectivesData>>,
		| number
		| Pick<
				QueryKey<OptionsLegacyParser<ListRetrospectivesData>>[0],
				"body" | "headers" | "path" | "query"
		  >
	>(
		// @ts-ignore
...
export const listRetrospectiveDiscussionsQueryKey = (
	options: OptionsLegacyParser<ListRetrospectiveDiscussionsData>
) => [createQueryKey("listRetrospectiveDiscussions", options)];

export const listRetrospectiveDiscussionsOptions = (
	options: OptionsLegacyParser<ListRetrospectiveDiscussionsData>
) => {
	return queryOptions({
		queryFn: async ({ queryKey, signal }) => {
...
export const listRetrospectiveDiscussionsInfiniteQueryKey = (
	options: OptionsLegacyParser<ListRetrospectiveDiscussionsData>
): QueryKey<OptionsLegacyParser<ListRetrospectiveDiscussionsData>> => [
	createQueryKey("listRetrospectiveDiscussions", options, true),
];

export const listRetrospectiveDiscussionsInfiniteOptions = (
	options: OptionsLegacyParser<ListRetrospectiveDiscussionsData>
) => {
	return infiniteQueryOptions<
		ListRetrospectiveDiscussionsResponse,
		ListRetrospectiveDiscussionsError,
		InfiniteData<ListRetrospectiveDiscussionsResponse>,
		QueryKey<OptionsLegacyParser<ListRetrospectiveDiscussionsData>>,
		| number
		| Pick<
				QueryKey<
...
export const createRetrospectiveDiscussionQueryKey = (
	options: OptionsLegacyParser<CreateRetrospectiveDiscussionData>
) => [createQueryKey("createRetrospectiveDiscussion", options)];

export const createRetrospectiveDiscussionOptions = (
	options: OptionsLegacyParser<CreateRetrospectiveDiscussionData>
) => {
	return queryOptions({
		queryFn: async ({ queryKey, signal }) => {
...
export const createRetrospectiveDiscussionMutation = (
	options?: Partial<OptionsLegacyParser<CreateRetrospectiveDiscussionData>>
) => {
	const mutationOptions: MutationOptions<
		CreateRetrospectiveDiscussionResponse,
		CreateRetrospectiveDiscussionError,
		OptionsLegacyParser<CreateRetrospectiveDiscussionData>
	> = {
		mutationFn: async (localOptions) => {
			const { data } = await createRetrospectiveDiscussion({
				...options,
...
export const getRetrospectiveDiscussionQueryKey = (
	options: OptionsLegacyParser<GetRetrospectiveDiscussionData>
) => [createQueryKey("getRetrospectiveDiscussion", options)];

export const getRetrospectiveDiscussionOptions = (
	options: OptionsLegacyParser<GetRetrospectiveDiscussionData>
) => {
	return queryOptions({
		queryFn: async ({ queryKey, signal }) => {
...
export const addRetrospectiveDiscussionReplyQueryKey = (
	options: OptionsLegacyParser<AddRetrospectiveDiscussionReplyData>
) => [createQueryKey("addRetrospectiveDiscussionReply", options)];

export const addRetrospectiveDiscussionReplyOptions = (
	options: OptionsLegacyParser<AddRetrospectiveDiscussionReplyData>
) => {
	return queryOptions({
		queryFn: async ({ queryKey, signal }) => {
...
export const addRetrospectiveDiscussionReplyMutation = (
	options?: Partial<OptionsLegacyParser<AddRetrospectiveDiscussionReplyData>>
) => {
	const mutationOptions: MutationOptions<
		AddRetrospectiveDiscussionReplyResponse,
		AddRetrospectiveDiscussionReplyError,
		OptionsLegacyParser<AddRetrospectiveDiscussionReplyData>
	> = {
		mutationFn: async (localOptions) => {
			const { data } = await addRetrospectiveDiscussionReply({
				...options,
...
export const updateRetrospectiveDiscussionMutation = (
	options?: Partial<OptionsLegacyParser<UpdateRetrospectiveDiscussionData>>
) => {
	const mutationOptions: MutationOptions<
		UpdateRetrospectiveDiscussionResponse,
		UpdateRetrospectiveDiscussionError,
		OptionsLegacyParser<UpdateRetrospectiveDiscussionData>
	> = {
		mutationFn: async (localOptions) => {
...
export const listRetrospectiveReviewsQueryKey = (
	options?: OptionsLegacyParser<ListRetrospectiveReviewsData>
) => [createQueryKey("listRetrospectiveReviews", options)];

export const listRetrospectiveReviewsOptions = (
	options?: OptionsLegacyParser<ListRetrospectiveReviewsData>
) => {
	return queryOptions({
		queryFn: async ({ queryKey, signal }) => {
...
export const listRetrospectiveReviewsInfiniteQueryKey = (
	options?: OptionsLegacyParser<ListRetrospectiveReviewsData>
): QueryKey<OptionsLegacyParser<ListRetrospectiveReviewsData>> => [
...
export const listRetrospectiveReviewsInfiniteOptions = (
	...
	return infiniteQueryOptions<
		ListRetrospectiveReviewsResponse,
		ListRetrospectiveReviewsError,
		InfiniteData<ListRetrospectiveReviewsResponse>,
		QueryKey<OptionsLegacyParser<ListRetrospectiveReviewsData>>,
		| number
		| Pick<
...
export const createRetrospectiveReviewQueryKey = (
	options: OptionsLegacyParser<CreateRetrospectiveReviewData>
) => [createQueryKey("createRetrospectiveReview", options)];

export const createRetrospectiveReviewOptions = (
	options: OptionsLegacyParser<CreateRetrospectiveReviewData>
) => {
	return queryOptions({
		queryFn: async ({ queryKey, signal }) => {
...
export const createRetrospectiveReviewMutation = (
	options?: Partial<OptionsLegacyParser<CreateRetrospectiveReviewData>>
) => {
	const mutationOptions: MutationOptions<
		CreateRetrospectiveReviewResponse,
		CreateRetrospectiveReviewError,
		OptionsLegacyParser<CreateRetrospectiveReviewData>
	> = {
		mutationFn: async (localOptions) => {
			const { data } = await createRetrospectiveReview({
				...options,
...
export const getSystemAnalysisComponentQueryKey = (
	options: OptionsLegacyParser<GetSystemAnalysisComponentData>
) => [createQueryKey("getSystemAnalysisComponent", options)];

export const getSystemAnalysisComponentOptions = (
	options: OptionsLegacyParser<GetSystemAnalysisComponentData>
) => {
	return queryOptions({
		queryFn: async ({ queryKey, signal }) => {
...
export const deleteSystemAnalysisComponentMutation = (
	options?: Partial<OptionsLegacyParser<DeleteSystemAnalysisComponentData>>
) => {
	const mutationOptions: MutationOptions<
		DeleteSystemAnalysisComponentResponse,
		DeleteSystemAnalysisComponentError,
		OptionsLegacyParser<DeleteSystemAnalysisComponentData>
	> = {
		mutationFn: async (localOptions) => {
...
export const updateSystemAnalysisComponentMutation = (
	options?: Partial<OptionsLegacyParser<UpdateSystemAnalysisComponentData>>
) => {
	const mutationOptions: MutationOptions<
		UpdateSystemAnalysisComponentResponse,
		UpdateSystemAnalysisComponentError,
		OptionsLegacyParser<UpdateSystemAnalysisComponentData>
	> = {
		mutationFn: async (localOptions) => {
...
export const getSystemAnalysisRelationshipQueryKey = (
	options: OptionsLegacyParser<GetSystemAnalysisRelationshipData>
) => [createQueryKey("getSystemAnalysisRelationship", options)];

export const getSystemAnalysisRelationshipOptions = (
	options: OptionsLegacyParser<GetSystemAnalysisRelationshipData>
) => {
	return queryOptions({
		queryFn: async ({ queryKey, signal }) => {
...
export const deleteSystemAnalysisRelationshipMutation = (
	options?: Partial<OptionsLegacyParser<DeleteSystemAnalysisRelationshipData>>
) => {
	const mutationOptions: MutationOptions<
		DeleteSystemAnalysisRelationshipResponse,
		DeleteSystemAnalysisRelationshipError,
		OptionsLegacyParser<DeleteSystemAnalysisRelationshipData>
	> = {
		mutationFn: async (localOptions) => {
...
export const updateSystemAnalysisRelationshipMutation = (
	options?: Partial<OptionsLegacyParser<UpdateSystemAnalysisRelationshipData>>
) => {
	const mutationOptions: MutationOptions<
		UpdateSystemAnalysisRelationshipResponse,
		UpdateSystemAnalysisRelationshipError,
		OptionsLegacyParser<UpdateSystemAnalysisRelationshipData>
	> = {
		mutationFn: async (localOptions) => {
...
export const listSystemAnalysisComponentsQueryKey = (
	options: OptionsLegacyParser<ListSystemAnalysisComponentsData>
) => [createQueryKey("listSystemAnalysisComponents", options)];

export const listSystemAnalysisComponentsOptions = (
	options: OptionsLegacyParser<ListSystemAnalysisComponentsData>
) => {
	return queryOptions({
		queryFn: async ({ queryKey, signal }) => {
...
export const addSystemAnalysisComponentQueryKey = (
	options: OptionsLegacyParser<AddSystemAnalysisComponentData>
) => [createQueryKey("addSystemAnalysisComponent", options)];

export const addSystemAnalysisComponentOptions = (
	options: OptionsLegacyParser<AddSystemAnalysisComponentData>
) => {
	return queryOptions({
		queryFn: async ({ queryKey, signal }) => {
...
export const addSystemAnalysisComponentMutation = (
	options?: Partial<OptionsLegacyParser<AddSystemAnalysisComponentData>>
) => {
	const mutationOptions: MutationOptions<
		AddSystemAnalysisComponentResponse,
		AddSystemAnalysisComponentError,
		OptionsLegacyParser<AddSystemAnalysisComponentData>
	> = {
		mutationFn: async (localOptions) => {
			const { data } = await addSystemAnalysisComponent({
				...options,
...
export const listSystemAnalysisRelationshipsQueryKey = (
	options: OptionsLegacyParser<ListSystemAnalysisRelationshipsData>
) => [createQueryKey("listSystemAnalysisRelationships", options)];

export const listSystemAnalysisRelationshipsOptions = (
	options: OptionsLegacyParser<ListSystemAnalysisRelationshipsData>
) => {
	return queryOptions({
		queryFn: async ({ queryKey, signal }) => {
...
export const listSystemAnalysisRelationshipsInfiniteQueryKey = (
	options: OptionsLegacyParser<ListSystemAnalysisRelationshipsData>
...
export const listSystemAnalysisRelationshipsInfiniteOptions = (
	options: OptionsLegacyParser<ListSystemAnalysisRelationshipsData>
) => {
	return infiniteQueryOptions<
		ListSystemAnalysisRelationshipsResponse,
		ListSystemAnalysisRelationshipsError,
		InfiniteData<ListSystemAnalysisRelationshipsResponse>,
		QueryKey<OptionsLegacyParser<ListSystemAnalysisRelationshipsData>>,
		| number
		| Pick<
				QueryKey<
...
export const createSystemAnalysisRelationshipQueryKey = (
	options: OptionsLegacyParser<CreateSystemAnalysisRelationshipData>
) => [createQueryKey("createSystemAnalysisRelationship", options)];

export const createSystemAnalysisRelationshipOptions = (
	options: OptionsLegacyParser<CreateSystemAnalysisRelationshipData>
) => {
	return queryOptions({
		queryFn: async ({ queryKey, signal }) => {
...
export const createSystemAnalysisRelationshipMutation = (
	options?: Partial<OptionsLegacyParser<CreateSystemAnalysisRelationshipData>>
) => {
	const mutationOptions: MutationOptions<
		CreateSystemAnalysisRelationshipResponse,
		CreateSystemAnalysisRelationshipError,
		OptionsLegacyParser<CreateSystemAnalysisRelationshipData>
	> = {
		mutationFn: async (localOptions) => {
			const { data } = await createSystemAnalysisRelationship({
				...options,
...
export const listSystemComponentsInfiniteQueryKey = (
	options?: OptionsLegacyParser<ListSystemComponentsData>
): QueryKey<OptionsLegacyParser<ListSystemComponentsData>> => [
...
export const listSystemComponentsInfiniteOptions = (
	...
	return infiniteQueryOptions<
		ListSystemComponentsResponse,
		ListSystemComponentsError,
		InfiniteData<ListSystemComponentsResponse>,
		QueryKey<OptionsLegacyParser<ListSystemComponentsData>>,
		| number
		| Pick<
				QueryKey<OptionsLegacyParser<ListSystemComponentsData>>[0],
				"body" | "headers" | "path" | "query"
		  >
	>(
		// @ts-ignore
...
export const createSystemComponentMutation = (
	options?: Partial<OptionsLegacyParser<CreateSystemComponentData>>
) => {
	const mutationOptions: MutationOptions<
		CreateSystemComponentResponse,
		CreateSystemComponentError,
		OptionsLegacyParser<CreateSystemComponentData>
	> = {
		mutationFn: async (localOptions) => {
			const { data } = await createSystemComponent({
				...options,
...
export const archiveSystemComponentMutation = (
	options?: Partial<OptionsLegacyParser<ArchiveSystemComponentData>>
) => {
	const mutationOptions: MutationOptions<
		ArchiveSystemComponentResponse,
		ArchiveSystemComponentError,
		OptionsLegacyParser<ArchiveSystemComponentData>
	> = {
		mutationFn: async (localOptions) => {
...
export const updateSystemComponentMutation = (
	options?: Partial<OptionsLegacyParser<UpdateSystemComponentData>>
) => {
	const mutationOptions: MutationOptions<
		UpdateSystemComponentResponse,
		UpdateSystemComponentError,
		OptionsLegacyParser<UpdateSystemComponentData>
	> = {
		mutationFn: async (localOptions) => {
...
export const createTaskMutation = (
	...
	const mutationOptions: MutationOptions<
		CreateTaskResponse,
		CreateTaskError,
		OptionsLegacyParser<CreateTaskData>
	> = {
		mutationFn: async (localOptions) => {
			const { data } = await createTask({
				...options,
...
export const archiveTaskMutation = (
	...
	const mutationOptions: MutationOptions<
		ArchiveTaskResponse,
		ArchiveTaskError,
		OptionsLegacyParser<ArchiveTaskData>
	> = {
		mutationFn: async (localOptions) => {
...
export const updateTaskMutation = (
	...
	const mutationOptions: MutationOptions<
		UpdateTaskResponse,
		UpdateTaskError,
		OptionsLegacyParser<UpdateTaskData>
	> = {
		mutationFn: async (localOptions) => {
...
export const createTeamMutation = (
	...
	const mutationOptions: MutationOptions<
		CreateTeamResponse,
		CreateTeamError,
		OptionsLegacyParser<CreateTeamData>
	> = {
		mutationFn: async (localOptions) => {
			const { data } = await createTeam({
				...options,
...
export const archiveTeamMutation = (
	...
	const mutationOptions: MutationOptions<
		ArchiveTeamResponse,
		ArchiveTeamError,
		OptionsLegacyParser<ArchiveTeamData>
	> = {
		mutationFn: async (localOptions) => {
...
export const updateTeamsMutation = (
	...
	const mutationOptions: MutationOptions<
		UpdateTeamsResponse,
		UpdateTeamsError,
		OptionsLegacyParser<UpdateTeamsData>
	> = {
		mutationFn: async (localOptions) => {
...
export const listUserAssignmentsInfiniteQueryKey = (
	options?: OptionsLegacyParser<ListUserAssignmentsData>
): QueryKey<OptionsLegacyParser<ListUserAssignmentsData>> => [
...
export const listUserAssignmentsInfiniteOptions = (
	...
	return infiniteQueryOptions<
		ListUserAssignmentsResponse,
		ListUserAssignmentsError,
		InfiniteData<ListUserAssignmentsResponse>,
		QueryKey<OptionsLegacyParser<ListUserAssignmentsData>>,
		| number
		| Pick<
				QueryKey<OptionsLegacyParser<ListUserAssignmentsData>>[0],
				"body" | "headers" | "path" | "query"
		  >
	>(
		// @ts-ignore
...
export const listUserNotificationsInfiniteQueryKey = (
	options?: OptionsLegacyParser<ListUserNotificationsData>
): QueryKey<OptionsLegacyParser<ListUserNotificationsData>> => [
...
export const listUserNotificationsInfiniteOptions = (
	...
	return infiniteQueryOptions<
		...
		| number
		| Pick<
				QueryKey<OptionsLegacyParser<ListUserNotificationsData>>[0],
				"body" | "headers" | "path" | "query"
		  >
	>(
		// @ts-ignore
...
export const deleteUserNotificationMutation = (
	options?: Partial<OptionsLegacyParser<DeleteUserNotificationData>>
) => {
	const mutationOptions: MutationOptions<
		DeleteUserNotificationResponse,
		DeleteUserNotificationError,
		OptionsLegacyParser<DeleteUserNotificationData>
	> = {
		mutationFn: async (localOptions) => {

...
export const createOncallAnnotationMutation = (options?: Partial<Options<CreateOncallAnnotationData>>) => {
...
export const deleteOncallAnnotationMutation = (options?: Partial<Options<DeleteOncallAnnotationData>>) => {
...
export const updateOncallAnnotationMutation = (options?: Partial<Options<UpdateOncallAnnotationData>>) => {

 ...
 */
export const completeAuthSessionFlowMutation = (options?: Partial<Options<CompleteAuthSessionFlowData>>): MutationOptions<CompleteAuthSessionFlowResponse, CompleteAuthSessionFlowError, Options<CompleteAuthSessionFlowData>> => {
    const mutationOptions: MutationOptions<CompleteAuthSessionFlowResponse, CompleteAuthSessionFlowError, Options<CompleteAuthSessionFlowData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await completeAuthSessionFlow({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const clearAuthSessionMutation = (options?: Partial<Options<ClearAuthSessionData>>): MutationOptions<ClearAuthSessionResponse, ClearAuthSessionError, Options<ClearAuthSessionData>> => {
    const mutationOptions: MutationOptions<ClearAuthSessionResponse, ClearAuthSessionError, Options<ClearAuthSessionData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await clearAuthSession({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const refreshAuthSessionMutation = (options?: Partial<Options<RefreshAuthSessionData>>): MutationOptions<RefreshAuthSessionResponse, RefreshAuthSessionError, Options<RefreshAuthSessionData>> => {
    const mutationOptions: MutationOptions<RefreshAuthSessionResponse, RefreshAuthSessionError, Options<RefreshAuthSessionData>> = {
        mutationFn: async (fnOptions) => {
 ...
 * Load document
 */
export const loadDocumentOptions = (options: Options<LoadDocumentData>) => queryOptions<LoadDocumentResponse, LoadDocumentError, LoadDocumentResponse, ReturnType<typeof loadDocumentQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
    ...
    queryKey: loadDocumentQueryKey(options)
});

/**
 * Update document
 */
export const updateDocumentMutation = (options?: Partial<Options<UpdateDocumentData>>): MutationOptions<UpdateDocumentResponse, UpdateDocumentError, Options<UpdateDocumentData>> => {
    const mutationOptions: MutationOptions<UpdateDocumentResponse, UpdateDocumentError, Options<UpdateDocumentData>> = {
        mutationFn: async (fnOptions) => {
 ...
 * List Integrations
 */
export const listConfiguredIntegrationsOptions = (options?: Options<ListConfiguredIntegrationsData>) => queryOptions<ListConfiguredIntegrationsResponse, ListConfiguredIntegrationsError, ListConfiguredIntegrationsResponse, ReturnType<typeof listConfiguredIntegrationsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await listConfiguredIntegrations({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: listConfiguredIntegrationsQueryKey(options)
});

export const listConfiguredIntegrationsInfiniteQueryKey = (options?: Options<ListConfiguredIntegrationsData>): QueryKey<Options<ListConfiguredIntegrationsData>> => createQueryKey('listConfiguredIntegrations', options, true);

/**
 * List Integrations
 */
export const listConfiguredIntegrationsInfiniteOptions = (options?: Options<ListConfiguredIntegrationsData>) => infiniteQueryOptions<ListConfiguredIntegrationsResponse, ListConfiguredIntegrationsError, InfiniteData<ListConfiguredIntegrationsResponse>, QueryKey<Options<ListConfiguredIntegrationsData>>, number | Pick<QueryKey<Options<ListConfiguredIntegrationsData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
// @ts-ignore
{
    queryFn: async ({ pageParam, queryKey, signal }) => {
        // @ts-ignore
        const page: Pick<QueryKey<Options<ListConfiguredIntegrationsData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
            query: {
                offset: pageParam
            }
        };
    ...
    queryKey: listConfiguredIntegrationsInfiniteQueryKey(options)
});
...
export const getConfiguredIntegrationQueryKey = (options: Options<GetConfiguredIntegrationData>) => createQueryKey('getConfiguredIntegration', options);

/**
 * Get an Integration
 */
export const getConfiguredIntegrationOptions = (options: Options<GetConfiguredIntegrationData>) => queryOptions<GetConfiguredIntegrationResponse, GetConfiguredIntegrationError, GetConfiguredIntegrationResponse, ReturnType<typeof getConfiguredIntegrationQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getConfiguredIntegration({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getConfiguredIntegrationQueryKey(options)
});
 ...
 */
export const updateConfiguredIntegrationPreferencesMutation = (options?: Partial<Options<UpdateConfiguredIntegrationPreferencesData>>): MutationOptions<UpdateConfiguredIntegrationPreferencesResponse, UpdateConfiguredIntegrationPreferencesError, Options<UpdateConfiguredIntegrationPreferencesData>> => {
    const mutationOptions: MutationOptions<UpdateConfiguredIntegrationPreferencesResponse, UpdateConfiguredIntegrationPreferencesError, Options<UpdateConfiguredIntegrationPreferencesData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await updateConfiguredIntegrationPreferences({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const archiveTeamMembershipMutation = (options?: Partial<Options<ArchiveTeamMembershipData>>): MutationOptions<ArchiveTeamMembershipResponse, ArchiveTeamMembershipError, Options<ArchiveTeamMembershipData>> => {
    const mutationOptions: MutationOptions<ArchiveTeamMembershipResponse, ArchiveTeamMembershipError, Options<ArchiveTeamMembershipData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await archiveTeamMembership({
                ...options,
                ...fnOptions,
                throwOnError: true
            });

 ...
 */
export const deleteConfiguredIntegrationMutation = (options?: Partial<Options<DeleteConfiguredIntegrationData>>): MutationOptions<DeleteConfiguredIntegrationResponse, DeleteConfiguredIntegrationError, Options<DeleteConfiguredIntegrationData>> => {
    const mutationOptions: MutationOptions<DeleteConfiguredIntegrationResponse, DeleteConfiguredIntegrationError, Options<DeleteConfiguredIntegrationData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await deleteConfiguredIntegration({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const updateConfiguredIntegrationMutation = (options?: Partial<Options<UpdateConfiguredIntegrationData>>): MutationOptions<UpdateConfiguredIntegrationResponse, UpdateConfiguredIntegrationError, Options<UpdateConfiguredIntegrationData>> => {
    const mutationOptions: MutationOptions<UpdateConfiguredIntegrationResponse, UpdateConfiguredIntegrationError, Options<UpdateConfiguredIntegrationData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await updateConfiguredIntegration({
                ...options,
                ...fnOptions,
                throwOnError: true
            });

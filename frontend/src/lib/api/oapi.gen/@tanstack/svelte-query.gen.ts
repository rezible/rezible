...
export const createEventAnnotationQueryKey = (options: Options<CreateEventAnnotationData>) => createQueryKey('createEventAnnotation', options);

/**
 * Create an Event Annotation
 */
export const createEventAnnotationOptions = (options: Options<CreateEventAnnotationData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
        ...
        queryKey: createEventAnnotationQueryKey(options)
    });
};
...
export const finishOrganizationSetupQueryKey = (options?: Options<FinishOrganizationSetupData>) => createQueryKey('finishOrganizationSetup', options);

/**
 * Finish initial org setup
 */
export const finishOrganizationSetupOptions = (options?: Options<FinishOrganizationSetupData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
        ...
        queryKey: finishOrganizationSetupQueryKey(options)
    });
};

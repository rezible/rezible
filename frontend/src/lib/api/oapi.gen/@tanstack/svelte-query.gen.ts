...
export const listAlertssQueryKey = (options?: Options<ListAlertssData>) => createQueryKey('listAlertss', options);

/**
 * List Alerts
 */
export const listAlertssOptions = (options?: Options<ListAlertssData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await listAlertss({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: listAlertssQueryKey(options)
    });
};
...
export const listAlertssInfiniteQueryKey = (options?: Options<ListAlertssData>): QueryKey<Options<ListAlertssData>> => createQueryKey('listAlertss', options, true);

/**
 * List Alerts
 */
export const listAlertssInfiniteOptions = (options?: Options<ListAlertssData>) => {
    return infiniteQueryOptions<ListAlertssResponse, ListAlertssError, InfiniteData<ListAlertssResponse>, QueryKey<Options<ListAlertssData>>, number | Pick<QueryKey<Options<ListAlertssData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
            const page: Pick<QueryKey<Options<ListAlertssData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
                query: {
                    offset: pageParam
                }
            };
        ...
        queryKey: listAlertssInfiniteQueryKey(options)
    });
};

export const getAlertsQueryKey = (options: Options<GetAlertsData>) => createQueryKey('getAlerts', options);

/**
 * Get Alert
 */
export const getAlertsOptions = (options: Options<GetAlertsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
        ...
        queryKey: getAlertsQueryKey(options)
    });
};
...
export const getPreviousOncallShiftOptions = (options: Options<GetPreviousOncallShiftData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getPreviousOncallShift({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getPreviousOncallShiftQueryKey(options)
    });
};
...
export const listPlaybookssQueryKey = (options?: Options<ListPlaybookssData>) => createQueryKey('listPlaybookss', options);

/**
 * List Playbooks
 */
export const listPlaybookssOptions = (options?: Options<ListPlaybookssData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await listPlaybookss({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: listPlaybookssQueryKey(options)
    });
};

export const listPlaybookssInfiniteQueryKey = (options?: Options<ListPlaybookssData>): QueryKey<Options<ListPlaybookssData>> => createQueryKey('listPlaybookss', options, true);

/**
 * List Playbooks
 */
export const listPlaybookssInfiniteOptions = (options?: Options<ListPlaybookssData>) => {
    return infiniteQueryOptions<ListPlaybookssResponse, ListPlaybookssError, InfiniteData<ListPlaybookssResponse>, QueryKey<Options<ListPlaybookssData>>, number | Pick<QueryKey<Options<ListPlaybookssData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
            const page: Pick<QueryKey<Options<ListPlaybookssData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
                query: {
                    offset: pageParam
                }
            };
        ...
        queryKey: listPlaybookssInfiniteQueryKey(options)
    });
};

export const createPlaybooksQueryKey = (options: Options<CreatePlaybooksData>) => createQueryKey('createPlaybooks', options);

/**
 * Create a Playbook
 */
export const createPlaybooksOptions = (options: Options<CreatePlaybooksData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await createPlaybooks({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: createPlaybooksQueryKey(options)
    });
};
 ...
 * Create a Playbook
 */
export const createPlaybooksMutation = (options?: Partial<Options<CreatePlaybooksData>>): MutationOptions<CreatePlaybooksResponse, CreatePlaybooksError, Options<CreatePlaybooksData>> => {
    const mutationOptions: MutationOptions<CreatePlaybooksResponse, CreatePlaybooksError, Options<CreatePlaybooksData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await createPlaybooks({
                ...options,
                ...localOptions,
 ...
 * Archive a Playbook
 */
export const archivePlaybooksMutation = (options?: Partial<Options<ArchivePlaybooksData>>): MutationOptions<ArchivePlaybooksResponse, ArchivePlaybooksError, Options<ArchivePlaybooksData>> => {
    const mutationOptions: MutationOptions<ArchivePlaybooksResponse, ArchivePlaybooksError, Options<ArchivePlaybooksData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await archivePlaybooks({
                ...options,
                ...localOptions,
                throwOnError: true
            });
...
export const getPlaybooksQueryKey = (options: Options<GetPlaybooksData>) => createQueryKey('getPlaybooks', options);

/**
 * Get Playbook
 */
export const getPlaybooksOptions = (options: Options<GetPlaybooksData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
        ...
        queryKey: getPlaybooksQueryKey(options)
    });
};
 ...
 * Update a Playbook
 */
export const updatePlaybooksMutation = (options?: Partial<Options<UpdatePlaybooksData>>): MutationOptions<UpdatePlaybooksResponse, UpdatePlaybooksError, Options<UpdatePlaybooksData>> => {
    const mutationOptions: MutationOptions<UpdatePlaybooksResponse, UpdatePlaybooksError, Options<UpdatePlaybooksData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await updatePlaybooks({
                ...options,
                ...localOptions,
                throwOnError: true
            });

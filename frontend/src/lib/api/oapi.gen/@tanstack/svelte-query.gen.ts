...
export const listOncallShiftEventsQueryKey = (options: Options<ListOncallShiftEventsData>) => createQueryKey('listOncallShiftEvents', options);

export const listOncallShiftEventsOptions = (options: Options<ListOncallShiftEventsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await listOncallShiftEvents({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: listOncallShiftEventsQueryKey(options)
    });
};

export const listOncallShiftEventsInfiniteQueryKey = (options: Options<ListOncallShiftEventsData>): QueryKey<Options<ListOncallShiftEventsData>> => createQueryKey('listOncallShiftEvents', options, true);

export const listOncallShiftEventsInfiniteOptions = (options: Options<ListOncallShiftEventsData>) => {
    return infiniteQueryOptions<ListOncallShiftEventsResponse, ListOncallShiftEventsError, InfiniteData<ListOncallShiftEventsResponse>, QueryKey<Options<ListOncallShiftEventsData>>, number | Pick<QueryKey<Options<ListOncallShiftEventsData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
            const page: Pick<QueryKey<Options<ListOncallShiftEventsData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
                query: {
                    offset: pageParam
                }
            };
        ...
        queryKey: listOncallShiftEventsInfiniteQueryKey(options)
    });
};

...
export const deleteIncidentMilestoneMutation = (options?: Partial<Options<DeleteIncidentMilestoneData>>) => {
...
export const listOncallEventAnnotationsQueryKey = (options?: Options<ListOncallEventAnnotationsData>) => createQueryKey('listOncallEventAnnotations', options);

export const listOncallEventAnnotationsOptions = (options?: Options<ListOncallEventAnnotationsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await listOncallEventAnnotations({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: listOncallEventAnnotationsQueryKey(options)
    });
};

export const listOncallEventAnnotationsInfiniteQueryKey = (options?: Options<ListOncallEventAnnotationsData>): QueryKey<Options<ListOncallEventAnnotationsData>> => createQueryKey('listOncallEventAnnotations', options, true);

export const listOncallEventAnnotationsInfiniteOptions = (options?: Options<ListOncallEventAnnotationsData>) => {
    return infiniteQueryOptions<ListOncallEventAnnotationsResponse, ListOncallEventAnnotationsError, InfiniteData<ListOncallEventAnnotationsResponse>, QueryKey<Options<ListOncallEventAnnotationsData>>, number | Pick<QueryKey<Options<ListOncallEventAnnotationsData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
            const page: Pick<QueryKey<Options<ListOncallEventAnnotationsData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
                query: {
                    offset: pageParam
                }
            };
        ...
        queryKey: listOncallEventAnnotationsInfiniteQueryKey(options)
    });
};

export const createOncallEventAnnotationQueryKey = (options: Options<CreateOncallEventAnnotationData>) => createQueryKey('createOncallEventAnnotation', options);

export const createOncallEventAnnotationOptions = (options: Options<CreateOncallEventAnnotationData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await createOncallEventAnnotation({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: createOncallEventAnnotationQueryKey(options)
    });
};

export const createOncallEventAnnotationMutation = (options?: Partial<Options<CreateOncallEventAnnotationData>>) => {
    const mutationOptions: MutationOptions<CreateOncallEventAnnotationResponse, CreateOncallEventAnnotationError, Options<CreateOncallEventAnnotationData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await createOncallEventAnnotation({
                ...options,
                ...localOptions,
...
export const deleteOncallEventAnnotationMutation = (options?: Partial<Options<DeleteOncallEventAnnotationData>>) => {
    const mutationOptions: MutationOptions<DeleteOncallEventAnnotationResponse, DeleteOncallEventAnnotationError, Options<DeleteOncallEventAnnotationData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await deleteOncallEventAnnotation({
                ...options,
                ...localOptions,
                throwOnError: true
            });
...
export const updateOncallEventAnnotationMutation = (options?: Partial<Options<UpdateOncallEventAnnotationData>>) => {
    const mutationOptions: MutationOptions<UpdateOncallEventAnnotationResponse, UpdateOncallEventAnnotationError, Options<UpdateOncallEventAnnotationData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await updateOncallEventAnnotation({
                ...options,
                ...localOptions,
                throwOnError: true
            });
...
export const updateOncallShiftHandoverMutation = (options?: Partial<Options<UpdateOncallShiftHandoverData>>) => {
...
export const removeWatchedOncallRosterMutation = (options?: Partial<Options<RemoveWatchedOncallRosterData>>) => {
...
export const addWatchedOncallRosterMutation = (options?: Partial<Options<AddWatchedOncallRosterData>>) => {
...
export const createRetrospectiveMutation = (options?: Partial<Options<CreateRetrospectiveData>>) => {
...
export const createSystemComponentRelationshipMutation = (options?: Partial<Options<CreateSystemComponentRelationshipData>>) => {
...
export const archiveSystemComponentRelationshipMutation = (options?: Partial<Options<ArchiveSystemComponentRelationshipData>>) => {
...
export const updateSystemComponentRelationshipMutation = (options?: Partial<Options<UpdateSystemComponentRelationshipData>>) => {

...
export const listSupportedIntegrationsQueryKey = (options?: Options<ListSupportedIntegrationsData>) => createQueryKey('listSupportedIntegrations', options);

/**
 * List Supported Integrations
 */
export const listSupportedIntegrationsOptions = (options?: Options<ListSupportedIntegrationsData>) => queryOptions<ListSupportedIntegrationsResponse, ListSupportedIntegrationsError, ListSupportedIntegrationsResponse, ReturnType<typeof listSupportedIntegrationsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await listSupportedIntegrations({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: listSupportedIntegrationsQueryKey(options)
});

export const listSupportedIntegrationsInfiniteQueryKey = (options?: Options<ListSupportedIntegrationsData>): QueryKey<Options<ListSupportedIntegrationsData>> => createQueryKey('listSupportedIntegrations', options, true);

/**
 * List Supported Integrations
 */
export const listSupportedIntegrationsInfiniteOptions = (options?: Options<ListSupportedIntegrationsData>) => infiniteQueryOptions<ListSupportedIntegrationsResponse, ListSupportedIntegrationsError, InfiniteData<ListSupportedIntegrationsResponse>, QueryKey<Options<ListSupportedIntegrationsData>>, number | Pick<QueryKey<Options<ListSupportedIntegrationsData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
// @ts-ignore
{
    queryFn: async ({ pageParam, queryKey, signal }) => {
        // @ts-ignore
        const page: Pick<QueryKey<Options<ListSupportedIntegrationsData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
            query: {
                offset: pageParam
            }
        };
    ...
    queryKey: listSupportedIntegrationsInfiniteQueryKey(options)
});

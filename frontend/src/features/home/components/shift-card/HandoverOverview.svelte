		...
		<div class="space-y-4">
			...
			<div>
				...
				<ul class="mt-2 text-sm">
					<li>
						Search latency: <span class="font-medium">p95 at 180ms</span> (within SLA)
					</li>
					<li>
						Error rate: <span class="font-medium">0.02%</span>
					</li>
					<li>
						Index freshness: <span class="font-medium">3min lag</span> (normal)
					</li>
				</ul>
			</div>
				...
				<a href="/incidents">
					<div class="mt-2 p-3 bg-danger-900/20 rounded-md hover:bg-danger-900/40 w-fit">
						<p class="text-sm font-medium">
							INC-4857: Intermittent 5xx errors from EU-West-2 replica
						</p>
						<ul class="mt-2 text-sm">
							<li>Started: 10/25 03:00 UTC</li>
							<li>Impact: ~0.1% of EU traffic affected</li>
							<li>Mitigation: Enabled fallback to EU-Central-1</li>
							<li>Next steps: AWS support investigating underlying cause</li>
						</ul>
					</div>
				</a>
				<a href="/incidents">
			...
			<div>
				...
				<ul class="mt-2 text-sm list-disc pl-5">
					...
					<li>Enabled circuit breaker for downstream recommendations service</li>
			...
			<div>
				...
				<ul class="mt-2 text-sm list-disc pl-5">
					...
					<li>New ranking model showing 2% lower CTR than baseline</li>
				</ul>
			</div>
			...
			<div>
				...
				<ol class="mt-2 text-sm list-decimal pl-5">
					<li>Monitor EU-West-2 recovery after AWS completes investigation</li>
					<li>Memory investigation ticket: SRCH-2245</li>
					<li>Ranking A/B test results due in 6hrs - rollback if CTR gap exceeds 3%</li>
				</ol>
			</div>
		</div>
	</div>

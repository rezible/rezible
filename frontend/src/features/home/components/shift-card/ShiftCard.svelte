...
<Card class="w-full max-h-full border-success-900/50 bg-success-900/5 rounded-lg overflow-auto" classes={{
	...
	<div slot="actions" class="flex gap-2 px-2 py-0 justify-end">
		<Button href="/oncall/shifts/{shift.id}" variant="fill-light" color="secondary">
			View Handover
		</Button>

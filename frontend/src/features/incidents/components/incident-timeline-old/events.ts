...
export let events: IncidentEvent[] = [
	...
	{ id: 'm3', title: "Alert Fired", type: 'milestone', start: addMinutes(start, 13), milestone: 'alert' },
	{
		id: 'm4',
	...
	{ id: 'm9', title: "Incident Mitigated", type: 'milestone', start: addMinutes(start, 45), milestone: 'mitigated' }
];

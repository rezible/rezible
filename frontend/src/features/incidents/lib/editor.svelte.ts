...
const createActiveStatus = () => {
	...
	return {
		...
		get italic() {
			return !!status.italic;
		},
		get code() {
			return !!status.code;
		},
		get codeBlock() {
			return !!status.codeBlock;
		},
		get bulletList() {
			return !!status.bulletList;
		},
		get orderedList() {
			return !!status.orderedList;
		},
		get taskList() {
			return !!status.taskList;
		},
		get blockquote() {
			return !!status.blockquote;
		},
		get heading1() {
			return !!status.heading1;
		},
		get heading2() {
			return !!status.heading2;
		},
		get paragraph() {

<script lang="ts">
	...
	import { getIncidentDebriefOptions, getIncidentUserDebriefOptions, updateIncidentDebriefMutation, type Incident, type IncidentDebrief } from "$lib/api";
...
<div class="p-2 text-surface-content" class:hidden={start.isSuccess}>
	...
	<p>
		We'll work through this together in a 
		blameless environment focused on improvement.
	</p>

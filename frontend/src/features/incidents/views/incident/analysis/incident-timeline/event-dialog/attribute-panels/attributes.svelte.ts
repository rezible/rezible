...
const ctx = new Context<TimelineEventDialogAttributes>("TimelineEventDialogAttributes");
export const initEventDialogAttributes = () => ctx.set(new TimelineEventDialogAttributes());
export const useEventDialogAttributes = () => ctx.get();
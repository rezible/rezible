...
export class PlaybookViewController {
...
const ctx = new Context<PlaybookViewController>("PlaybookViewController");
export const initPlaybookViewController = (idFn: Getter<string>) => ctx.set(new PlaybookViewController(idFn));
export const usePlaybookViewController = () => ctx.get();
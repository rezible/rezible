<script lang="ts">
	...
	import { getOncallShiftHandoverOptions, getOncallShiftHandoverTemplateOptions, listOncallShiftAnnotationsOptions, listOncallShiftIncidentsOptions, tryUnwrapApiError } from "$lib/api";

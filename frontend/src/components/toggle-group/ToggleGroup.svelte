<!-- Taken from svelte-ux - exists to facilitate setting a ToggleOption as disabled -->
...
<div class={cls("ToggleGroup", `variant-${variant}`, $classesStore.root, $$props.class)} {...$$restProps}>

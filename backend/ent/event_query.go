...
func (_q *EventQuery) QueryTenant() *TenantQuery {
...
func (_q *EventQuery) QueryAlertInstance() *AlertInstanceQuery {
...
func (_q *EventQuery) QueryIncidentEvent() *IncidentEventQuery {
...
func (_q *EventQuery) QueryAnnotations() *EventAnnotationQuery {
...
func (_q *EventQuery) Clone() *EventQuery {
	...
	return &EventQuery{
		...
		withIncidentEvent: _q.withIncidentEvent.Clone(),
...
func (_q *EventQuery) WithTenant(opts ...func(*TenantQuery)) *EventQuery {
	query := (&TenantClient{config: _q.config}).Query()
...
func (_q *EventQuery) WithAlertInstance(opts ...func(*AlertInstanceQuery)) *EventQuery {
	query := (&AlertInstanceClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *EventQuery) WithIncidentEvent(opts ...func(*IncidentEventQuery)) *EventQuery {
	query := (&IncidentEventClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withIncidentEvent = query
	return _q
}
...
func (_q *EventQuery) WithAnnotations(opts ...func(*EventAnnotationQuery)) *EventQuery {
	query := (&EventAnnotationClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *EventQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Event, error) {
	...
	if query := _q.withAlertInstance; query != nil {
		if err := _q.loadAlertInstance(ctx, query, nodes,
	...
	if query := _q.withIncidentEvent; query != nil {
		if err := _q.loadIncidentEvent(ctx, query, nodes,
...
func (_q *EventQuery) loadTenant(ctx context.Context, query *TenantQuery, nodes []*Event, init func(*Event), assign func(*Event, *Tenant)) error {
...
func (_q *EventQuery) loadAlertInstance(ctx context.Context, query *AlertInstanceQuery, nodes []*Event, init func(*Event), assign func(*Event, *AlertInstance)) error {
...
func (_q *EventQuery) loadIncidentEvent(ctx context.Context, query *IncidentEventQuery, nodes []*Event, init func(*Event), assign func(*Event, *IncidentEvent)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Event)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
...
func (_q *EventQuery) loadAnnotations(ctx context.Context, query *EventAnnotationQuery, nodes []*Event, init func(*Event), assign func(*Event, *EventAnnotation)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Event)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)

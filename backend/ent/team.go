...
// QueryDocumentAccesses queries the "document_accesses" edge of the Team entity.
func (_m *Team) QueryDocumentAccesses() *DocumentAccessQuery {
	return NewTeamClient(_m.config).QueryDocumentAccesses(_m)
}

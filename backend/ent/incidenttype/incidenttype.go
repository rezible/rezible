...
const (
	// Label holds the string label denoting the incidenttype type in the database.
	Label = "incident_type"
	...
	// Table holds the table name of the incidenttype in the database.
	Table = "incident_types"
	// TenantTable is the table that holds the tenant relation/edge.
	TenantTable = "incident_types"
...
// Columns holds all SQL columns for incidenttype fields.
var Columns = []string{
	FieldID,
	FieldTenantID,
	FieldArchiveTime,
...
var (
	...
	DebriefQuestionsPrimaryKey = []string{"incident_debrief_question_id", "incident_type_id"}
)
...
// OrderOption defines the ordering options for the IncidentType queries.

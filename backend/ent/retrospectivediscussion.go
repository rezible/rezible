...
func (e RetrospectiveDiscussionEdges) TenantOrErr() (*Tenant, error) {
	if e.Tenant != nil {
		return e.Tenant, nil
...
// QueryTenant queries the "tenant" edge of the RetrospectiveDiscussion entity.
func (rd *RetrospectiveDiscussion) QueryTenant() *TenantQuery {
	return NewRetrospectiveDiscussionClient(rd.config).QueryTenant(rd)
}
...
func (rd *RetrospectiveDiscussion) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", rd.TenantID))
	builder.WriteString(", ")

...
const (
	// Label holds the string label denoting the incidenttag type in the database.
	Label = "incident_tag"
	...
	// Table holds the table name of the incidenttag in the database.
	Table = "incident_tags"
	// TenantTable is the table that holds the tenant relation/edge.
	TenantTable = "incident_tags"
	...
	IncidentsTable = "incident_tag_assignments"
	...
	DebriefQuestionsTable = "incident_debrief_question_incident_tags"
...
// Columns holds all SQL columns for incidenttag fields.
var Columns = []string{
	FieldID,
	FieldTenantID,
	FieldArchiveTime,
...
var (
	...
	IncidentsPrimaryKey = []string{"incident_id", "incident_tag_id"}
	...
	DebriefQuestionsPrimaryKey = []string{"incident_debrief_question_id", "incident_tag_id"}
)
...
// OrderOption defines the ordering options for the IncidentTag queries.

...
const (
	// Label holds the string label denoting the systemrelationship type in the database.
	Label = "system_relationship"
	...
	SourceComponentTable = "system_relationships"
	...
	TargetComponentTable = "system_relationships"
...
// OrderOption defines the ordering options for the SystemRelationship queries.

...
const (
	// Label holds the string label denoting the systemcomponentrelationshipfeedback type in the database.
	Label = "system_component_relationship_feedback"
	...
	// Table holds the table name of the systemcomponentrelationshipfeedback in the database.
	Table = "system_component_relationship_feedbacks"
	// SignalTable is the table that holds the signal relation/edge.
	SignalTable = "system_component_relationship_feedbacks"
	...
	RelationshipTable = "system_component_relationship_feedbacks"
...
// Columns holds all SQL columns for systemcomponentrelationshipfeedback fields.
var Columns = []string{
	FieldID,
	FieldRelationshipID,
	FieldSignalID,
...
// OrderOption defines the ordering options for the SystemComponentRelationshipFeedback queries.

...
const (
	// Label holds the string label denoting the systemrelationshipfeedback type in the database.
	Label = "system_relationship_feedback"
	...
	// Table holds the table name of the systemrelationshipfeedback in the database.
	Table = "system_relationship_feedbacks"
	// SignalTable is the table that holds the signal relation/edge.
	SignalTable = "system_relationship_feedbacks"
	...
	RelationshipTable = "system_relationship_feedbacks"
...
// Columns holds all SQL columns for systemrelationshipfeedback fields.
var Columns = []string{
	FieldID,
	FieldRelationshipID,
	FieldSignalID,
...
// OrderOption defines the ordering options for the SystemRelationshipFeedback queries.

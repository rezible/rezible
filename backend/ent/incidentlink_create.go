...
func (_c *IncidentLinkCreate) SetTenantID(v int) *IncidentLinkCreate {
	_c.mutation.SetTenantID(v)
	return _c
}

// SetIncidentID sets the "incident_id" field.
func (_c *IncidentLinkCreate) SetIncidentID(v uuid.UUID) *IncidentLinkCreate {
	_c.mutation.SetIncidentID(v)
	return _c
}

// SetLinkedIncidentID sets the "linked_incident_id" field.
func (_c *IncidentLinkCreate) SetLinkedIncidentID(v uuid.UUID) *IncidentLinkCreate {
	_c.mutation.SetLinkedIncidentID(v)
	return _c
}
...
func (_c *IncidentLinkCreate) SetNillableDescription(v *string) *IncidentLinkCreate {
	if v != nil {
		_c.SetDescription(*v)
	}
	return _c
...
func (_c *IncidentLinkCreate) SetTenant(v *Tenant) *IncidentLinkCreate {
	return _c.SetTenantID(v.ID)
}

// SetIncident sets the "incident" edge to the Incident entity.
func (_c *IncidentLinkCreate) SetIncident(v *Incident) *IncidentLinkCreate {
	return _c.SetIncidentID(v.ID)
}

// SetLinkedIncident sets the "linked_incident" edge to the Incident entity.
func (_c *IncidentLinkCreate) SetLinkedIncident(v *Incident) *IncidentLinkCreate {
	return _c.SetLinkedIncidentID(v.ID)
}

// Mutation returns the IncidentLinkMutation object of the builder.
func (_c *IncidentLinkCreate) Mutation() *IncidentLinkMutation {
	return _c.mutation
}

// Save creates the IncidentLink in the database.
func (_c *IncidentLinkCreate) Save(ctx context.Context) (*IncidentLink, error) {
	return withHooks(ctx, _c.sqlSave, _c.mutation, _c.hooks)
}

// SaveX calls Save and panics if Save returns an error.
func (_c *IncidentLinkCreate) SaveX(ctx context.Context) *IncidentLink {
	v, err := _c.Save(ctx)
	if err != nil {
		panic(err)
	}
...
func (_c *IncidentLinkCreate) Exec(ctx context.Context) error {
	_, err := _c.Save(ctx)
	return err
}

// ExecX is like Exec, but panics if an error occurs.
func (_c *IncidentLinkCreate) ExecX(ctx context.Context) {
...
func (_c *IncidentLinkCreate) check() error {
	...
	if _, ok := _c.mutation.LinkedIncidentID(); !ok {
...
func (_c *IncidentLinkCreate) createSpec() (*IncidentLink, *sqlgraph.CreateSpec) {
	var (
	...
	if nodes := _c.mutation.LinkedIncidentIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
...
//		}).
//		Exec(ctx)
func (_c *IncidentLinkCreate) OnConflict(opts ...sql.ConflictOption) *IncidentLinkUpsertOne {
	_c.conflict = opts
...
//		Exec(ctx)
func (_c *IncidentLinkCreate) OnConflictColumns(columns ...string) *IncidentLinkUpsertOne {
...
func (_c *IncidentLinkCreateBulk) Save(ctx context.Context) ([]*IncidentLink, error) {
	if _c.err != nil {
		return nil, _c.err
	}
	specs := make([]*sqlgraph.CreateSpec, len(_c.builders))
	nodes := make([]*IncidentLink, len(_c.builders))
...
func (_c *IncidentLinkCreateBulk) SaveX(ctx context.Context) []*IncidentLink {
	v, err := _c.Save(ctx)
	if err != nil {
		panic(err)
	}
...
// Exec executes the query.
func (_c *IncidentLinkCreateBulk) Exec(ctx context.Context) error {
	_, err := _c.Save(ctx)
	return err
}

// ExecX is like Exec, but panics if an error occurs.
func (_c *IncidentLinkCreateBulk) ExecX(ctx context.Context) {
	if err := _c.Exec(ctx); err != nil {
		panic(err)
	}
}
...
//		}).
//		Exec(ctx)
func (_c *IncidentLinkCreateBulk) OnConflict(opts ...sql.ConflictOption) *IncidentLinkUpsertBulk {
	_c.conflict = opts
...
//		OnConflict(sql.ConflictColumns(columns...)).
//		Exec(ctx)
func (_c *IncidentLinkCreateBulk) OnConflictColumns(columns ...string) *IncidentLinkUpsertBulk {
	_c.conflict = append(_c.conflict, sql.ConflictColumns(columns...))
	return &IncidentLinkUpsertBulk{
		create: _c,
	}

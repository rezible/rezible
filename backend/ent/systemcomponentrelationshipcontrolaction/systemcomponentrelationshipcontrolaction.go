...
const (
	// Label holds the string label denoting the systemcomponentrelationshipcontrolaction type in the database.
	Label = "system_component_relationship_control_action"
	...
	// Table holds the table name of the systemcomponentrelationshipcontrolaction in the database.
	Table = "system_component_relationship_control_actions"
	// ControlTable is the table that holds the control relation/edge.
	ControlTable = "system_component_relationship_control_actions"
	...
	RelationshipTable = "system_component_relationship_control_actions"
...
// Columns holds all SQL columns for systemcomponentrelationshipcontrolaction fields.
var Columns = []string{
	FieldID,
	FieldControlID,
	FieldRelationshipID,
...
// OrderOption defines the ordering options for the SystemComponentRelationshipControlAction queries.

...
type OncallShiftHandoverResponseData struct {
	Exists        bool                 `json:"exists"`
	Autogenerated bool                 `json:"autogenerated"`
	Handover      *OncallShiftHandover `json:"handover"`
}
type GetOncallShiftHandoverResponse ItemResponse[OncallShiftHandoverResponseData]
